...
export declare interface IClientSideWebPartManifest<TProperties> extends IClientSideComponentManifest {
    ...
    /**
     * Optional JSON schema definition of the web part's properties.
     * If provided, the schema will be provide additional validation for the type safety of the web part's persisted format.
     *
