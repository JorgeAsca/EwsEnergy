...
import type { IOAuthToken } from '@msinternal/sp-client-shared';
import type { IOAuthUtilityInteractionHandlerInfo } from '@msinternal/sp-client-shared';
import type { OAuthTokenType } from '@msinternal/sp-client-shared';
...
export declare class AadHttpClient {
    ...
    private _fetch;
    private _getTokenFetchPromise;
    private _getFetchCorePromise;
}
 ...
 * @sealed
 */
export declare class AadTokenProvider {
    ...
    /* Excluded from this release type: _setSupportsNestedAppAuth */
    /* Excluded from this release type: _ensureState */
    ...
    /* Excluded from this release type: _ensureTelemetry */
...
export declare class AadTokenProviderFactory {
    ...
    /* Excluded from this release type: _getPreAuthorizedTokenProvider */
}
 ...
 * @public
 */
export declare class BeforeFullPageRedirectEventArgs {
    /**
...
/* Excluded from this release type: _DeferredCookieRefresher */

/* Excluded from this release type: _DEPRECATED_DO_NOT_USE_OAuthTokenProvider */
...
export declare interface IAadTokenProviderConfiguration {
    ...
    /* Excluded from this release type: enableMetaOS */
    /* Excluded from this release type: isMsalTokenProviderPopupEnabled */
    /* Excluded from this release type: thirdPartyReplyUrisUpdated */
    /* Excluded from this release type: isAnonymousGuestUser */
    /* Excluded from this release type: isEmailAuthenticationGuestUser */
    /* Excluded from this release type: isNaaSupported */
    /* Excluded from this release type: isPairwiseBrokerEnabled */
    /* Excluded from this release type: eventNamespace */
    /* Excluded from this release type: msGraphEndpointUrl */
}
 ...
 * @public
 */
export declare enum IAuthenticationScheme {
    BEARER = "Bearer",
    POP = "pop"
}
 ...
 * @public
 */
export declare interface IGetTokenDataOptions {
    useCachedToken: boolean;
...
/* Excluded from this release type: _IGetTokenDataOptions_ITokenProvider */

/**
 * @public
 */
export declare interface IGetTokenOptions {
    useCachedToken?: boolean;
    claims?: string;
    /* Excluded from this release type: scopes */
    /**
     * Indicates whether acquire a Bearer or PoP
     * By defalut authenticationScheme is Bearer.
     */
    authenticationScheme?: IAuthenticationScheme;
    /**
     ...
     */
    shrClaims?: string;
    /* Excluded from this release type: callersQosName */
    /* Excluded from this release type: cancelRedirect */
}

/* Excluded from this release type: _IGetTokenOptions_ITokenProvider */
...
export declare interface IHttpClientOptions extends RequestInit {
    /* Excluded from this release type: _authenticationScheme */
    /* Excluded from this release type: _resourceRequestMethod */
    /* Excluded from this release type: _shrClaims */
}

/* Excluded from this release type: _IHttpRequestCacheOptions */

/* Excluded from this release type: _IInternalAadTokenProvider */

/* Excluded from this release type: _InternalAadTokenProvider */
 ...
 * @public
 */
export declare interface IPopupEventArgs extends SPEventArgs {
    /**
...
/* Excluded from this release type: _ISPCookieRefresher */
...
export declare interface ISPHttpClientCommonConfiguration extends IHttpClientConfiguration {
     ...
     *
     * @remarks
     * When this switch is true popup auth will be used for handling a cookie refresh.
     * This means the caller must handle the popup events.  If it is undefined or false
     * full page redirect will be defaulted to.
     */
...
/* Excluded from this release type: _OBO3PTokenFunction */

/* Excluded from this release type: _OBOTokenFunction */
 ...
 * @public
 */
export declare class PopupRequestEventArgs {
    /**
     * A handler should call this from user interaction to ensure the browser does not
...
export declare class SPHttpClient {
    ...
    private static _logSource;
    private static _onBeforeRedirectEventId;
    private static _onPopupRequestedEventId;
...
export declare class SPHttpClientConfiguration extends SPHttpClientCommonConfiguration implements ISPHttpClientConfiguration {
    ...
    /**
     * {@inheritDoc ISPHttpClientConfiguration.usePopupForCookieRefresh}
     */
