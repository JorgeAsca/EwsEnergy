...
var SPHttpClientBatch = /** @class */ (function () {
    ...
    /**
     * Get size of curent batched requests.
     * @returns count of batched requests.
     * @internal
     */
    SPHttpClientBatch.prototype.batchedSize = function () {
        var _a;
        return ((_a = this._batchedRequests) === null || _a === void 0 ? void 0 : _a.length) || 0;
    };
    /**
    ...
    SPHttpClientBatch.prototype.execute = function () {
        ...
        this._batchedRequests.forEach(function (batchedRequest) {
            chain = chain
                ...
                batchBody += "--batch_".concat(batchGuid.toString(), "\n");
                batchBody += "Content-type: application/http\n";
                batchBody += "Content-Transfer-Encoding: binary\n\n";
                // Example:
                // "POST https://example.com/_api/web HTTP/1.1"
                batchBody += "".concat(request.method, " ").concat(request.url, " HTTP/1.1\n");
                request.headers.forEach(function (value, name) {
                    batchBody += "".concat(name, ": ").concat(value, "\n");
                });
                batchBody += '\n';
        ...
        return chain
            ...
            batchBody += "--batch_".concat(batchGuid, "--\n\n");
            ...
            headers.append('Content-Type', "multipart/mixed; boundary=batch_".concat(batchGuid));
            ...
            if (!response.ok) {
                throw new Error('SPHttpClientBatch: The batch request failed: ' + response.status.toString());
            }
            ...
            if (responses.length !== _this._batchedRequests.length) {
                throw new Error("SPHttpClientBatch: Expecting ".concat(_this._batchedRequests.length, " responses"));
            }
