...
import type { IFetchProvider } from '../httpClient/FetchProvider';
import type IDigestCache from './IDigestCache';
import type SPHttpClientCommonConfiguration from './SPHttpClientCommonConfiguration';
import type { ISPHttpClientOptions } from './SPHttpClient';
...
import type ISPCookieRefresher from './ISPCookieRefresher';
/**
...
export default class SPHttpClientHelper {
    ...
    static applyDefaultHeaders(headers: Headers, configuration: SPHttpClientCommonConfiguration, options: ISPHttpClientOptions, oDataVersion: ODataVersion | undefined, originalCorrelationId?: string): void;
    /**
     ...
     */
    static fetchCore(url: string, configuration: SPHttpClientConfiguration, options: ISPHttpClientOptions, serviceScope: ServiceScope, digestCache: IDigestCache, fetchProvider: IFetchProvider, cookieRefresher: ISPCookieRefresher, logSourceId: string, originalCorrelationId?: string): Promise<SPHttpClientResponse>;
    /**
