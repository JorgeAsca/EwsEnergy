...
import { SPHttpHeader } from './SPHttpHeader';
/**
...
var SPHttpClientResponse = /** @class */ (function (_super) {
    ...
    Object.defineProperty(SPHttpClientResponse.prototype, "correlationId", {
        ...
        get: function () {
            if (!this._correlationId) {
                this._correlationId = Guid.tryParse(this.headers.get(SPHttpHeader.SPRequestGuid));
            }
    ...
    Object.defineProperty(SPHttpClientResponse.prototype, "statusMessage", {
        ...
        get: function () {
            ...
            return "[HTTP]:".concat(this.status, " - ").concat(this.statusText, " [CorrelationId]:").concat(correlationId, " [Version]:").concat(spVersion);
        },
        enumerable: false,
        configurable: true
    });
