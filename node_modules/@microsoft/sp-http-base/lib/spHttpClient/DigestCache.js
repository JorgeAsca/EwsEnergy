 ...
 */
import { ServiceKey, TimeProvider, UrlUtilities } from '@microsoft/sp-core-library';
import { _LogSource, _TraceLogger } from '@microsoft/sp-diagnostics';
import { getSafeWebServerRelativeUrl } from '@msinternal/odsp-datasources/lib/interfaces/ISpPageContext';
import { isEnableUnifiedAdminUrlWithGeoSpecificTenantNameFlightEnabled } from '../common/Flights';
...
var DigestCache = /** @class */ (function () {
    ...
    DigestCache.prototype.fetchDigest = function (webUrl) {
        ...
        var digestUrl = isEnableUnifiedAdminUrlWithGeoSpecificTenantNameFlightEnabled() &&
            !!((_a = window._spPageContextInfo) === null || _a === void 0 ? void 0 : _a.isUnifiedAdminUrl)
            ? "".concat(normalizedWebUrl).concat(getSafeWebServerRelativeUrl(window._spPageContextInfo), "/_api/contextinfo")
    ...
    DigestCache.prototype.clearDigest = function (webUrl) {
        ...
        _TraceLogger.logVerbose(DigestCache._logSource, "DigestCache: Requested to clear cache entry: ".concat(found ? 'found' : 'not found'));
        return found;
    };
    /**
