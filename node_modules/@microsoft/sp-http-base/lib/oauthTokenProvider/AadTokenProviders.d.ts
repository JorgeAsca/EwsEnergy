import type { IInternalAadTokenProvider, IAadTokenProviderConfiguration } from './IAadTokenProvider';
/**
 ...
 * @internal
 */
export default class AadTokenProviders {
    private static _configurableTokenProvider;
    private static _preAuthorizedConfiguration;
    /**
     * Initializes the AadTokenProviders. Must be called before fetching AadTokenProvider objects.
     * @internal
     */
    static _initialize(configurable: IInternalAadTokenProvider, preAuthorizedConfig: IAadTokenProviderConfiguration): void;
    /**
     ...
     */
    static get configurable(): IInternalAadTokenProvider;
    /**
     ...
     */
    static get preAuthorizedConfiguration(): IAadTokenProviderConfiguration;
}
//# sourceMappingURL=AadTokenProviders.d.ts.map