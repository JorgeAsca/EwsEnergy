...
var TokenUtilityLogger = /** @class */ (function () {
    ...
    TokenUtilityLogger.prototype.logInfo = function (message) {
        _TraceLogger.logVerbose(TokenUtilityLogger._logSource, message);
    };
    TokenUtilityLogger.prototype.logError = function (message) {
        _TraceLogger.logError(TokenUtilityLogger._logSource, new Error(message));
    };
    TokenUtilityLogger.prototype.logWarning = function (message) {
        _TraceLogger.logVerbose(TokenUtilityLogger._logSource, 'Warning: ' + message);
    };
    TokenUtilityLogger._logSource = _LogSource.create('TokenUtility');
...
var OAuthUtilityContext = /** @class */ (function () {
    ...
    OAuthUtilityContext.prototype.qosMonitor = function () {
        return new _QosMonitor(OAuthUtilityContext._qosName);
    };
