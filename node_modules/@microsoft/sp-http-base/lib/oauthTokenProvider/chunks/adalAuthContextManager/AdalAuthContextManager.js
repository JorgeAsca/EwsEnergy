...
var AdalAuthContextManager = /** @class */ (function () {
    ...
    AdalAuthContextManager.prototype.getOboTokenProvider = function (tokenProviderConfiguration, sharePointOBOProviderConfiguration, oboFirstyPartyTokenCallback, oboThirdPartyTokenCallback) {
        return new OboTokenProvider(AuthenticationContext.inject(AdalAuthContextManager.convertTokenParametersToConfig(tokenProviderConfiguration)), sharePointOBOProviderConfiguration, oboFirstyPartyTokenCallback, oboThirdPartyTokenCallback);
    };
