...
import type { ISPOBOFlowParameters, ITokenProvider, _OBO3PTokenFunction, OBOTokenFunction } from '../../ITokenProvider';
/**
 ...
 * @internal
 */
export declare class AdalAuthContextManager {
    /**
    ...
    constructor();
    getOboTokenProvider(tokenProviderConfiguration: IAadTokenProviderConfiguration, sharePointOBOProviderConfiguration: ISPOBOFlowParameters, oboFirstyPartyTokenCallback?: OBOTokenFunction, oboThirdPartyTokenCallback?: _OBO3PTokenFunction): ITokenProvider;
