import type * as AuthenticationContext from 'adal-angular';
import type { IAuthenticationContextInternal, IGetTokenOptions, ITokenProvider } from '../../ITokenProvider';
/**
 * Class that wraps the ADAL's authentication class
 * @internal
 */
export default class AdalAuthContext implements ITokenProvider {
