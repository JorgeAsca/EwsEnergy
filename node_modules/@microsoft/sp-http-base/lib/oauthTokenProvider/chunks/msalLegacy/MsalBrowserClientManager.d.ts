import { type IPublicClientApplication } from '@azure/msal-browser-legacy-1p';
/**
 ...
 */
export declare class MsalBrowserClientManager {
    private static _msalBrowserClients;
    private static readonly _LOCAL_STORAGE_TEST_STRING;
    private static readonly _NAA_CLIENT_SUFFIX;
    private static readonly _PAIRWISEBROKER_CLIENT_SUFFIX;
    /**
     ...
     */
    static registerMsalBrowserClient(authority: string, clientId: string, redirectUri: string, isNaaSupported: boolean, isPairwiseBrokerEnabled: boolean): void;
    /**
     ...
     */
    static getMsalBrowserClient(authority: string, clientId: string, redirectUri: string, isNaaSupported: boolean, isPairwiseBrokerEnabled: boolean): Promise<IPublicClientApplication>;
    private static _isClientIndexRegistered;
    private static _getClientIdIndex;
    /**
     ...
     */
    private static _createMsalBrowserClient;
    private static _createMsalBrowserNextClient;
    private static _createMsalBrowserPairwiseBrokerClient;
    private static _getMsalBrowserConfiguration;
