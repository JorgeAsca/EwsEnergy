 ...
 * @public
 */
export default class AadHttpClientFactory {
    /**
     ...
     * @internal
     */
    _getStandardClient(resourceEndpoint: string): Promise<AadHttpClient>;
}
//# sourceMappingURL=AadHttpClientFactory.d.ts.map