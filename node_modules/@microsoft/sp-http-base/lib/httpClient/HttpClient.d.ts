...
import type { IHttpClientConfigurations } from './HttpClientConfiguration';
import type HttpClientConfiguration from './HttpClientConfiguration';
...
import type { IAuthenticationScheme } from '../oauthTokenProvider/ITokenProvider';
/**
...
export interface IHttpClientOptions extends RequestInit {
     ...
     * @internal
     */
    _authenticationScheme?: IAuthenticationScheme;
    /**
     * A stringified JSON object containing custom client claims
     *
     * @internal
     */
    _resourceRequestMethod?: string;
    /**
     * A stringified JSON object containing custom client claims
     *
     * @internal
