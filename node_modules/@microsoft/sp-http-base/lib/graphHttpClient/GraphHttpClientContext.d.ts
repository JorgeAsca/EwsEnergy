 ...
 * @internal
 */
export default class GraphHttpClientContext {
    /**
     * The service key for GraphHttpClientContext.
     */
    static readonly serviceKey: ServiceKey<GraphHttpClientContext>;
    private _webServerRelativeUrl;
    private _graphEndpointUrl;
     ...
     */
    initialize(webServerRelativeUrl: string, graphEndpointUrl: string, webAbsoluteUrl: string): void;
    /**
...
//# sourceMappingURL=GraphHttpClientContext.d.ts.map