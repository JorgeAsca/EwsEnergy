...
var AadConstants = /** @class */ (function () {
     ...
     * {@link https://docs.microsoft.com/en-us/azure/active-directory/develop/active-directory-application-objects}
     */
    AadConstants.ODC_AAD_APP_PRINCIPAL_ID = '865367a6-9c28-4844-88ce-259d34dbabae';
    /**
     * This GUID is the unique identifier for Isolsated SPFx first party principal
     * @internal
     */
    AadConstants.PRE_AUTHORIZED_ISOLATED_APP_PRINCIPAL_ID = '3bc2296e-aa22-4ed2-9e1e-946d05afa6a2';
    /**
    ...
    AadConstants.UNRESOLVABLE_AAD_ERROR_CODES = new Set([
        'AADSTS65001', // App did not consent
        'AADSTS53000', // Unmanaged Device
        'AADSTS53003', // Conditional Access Policies
        'AADSTS500011', // App not installed or consented
     ...
     * {@link https://docs.microsoft.com/en-us/azure/active-directory/develop/reference-aadsts-error-codes}
     */
    AadConstants.CONDITIONAL_ACCESS_POLICY_ERRORS = new Set([
        'AADSTS53000', // Unmanaged Device
        'AADSTS53001', // Device not domain joined
        'AADSTS53002', // Application use is not an approved app
        'AADSTS53003' // Conditional Access Policies
    ]);
    /**
    ...
    /**
     * Error code from MSALjs for timeout
     */
    AadConstants.MONITOR_WINDOW_TIMEOUT = 'monitor_window_timeout';
    /**
     * Error code from AAD for network error
     */
    AadConstants.ENDPOINTS_RESOLUTION_ERROR = 'endpoints_resolution_error';
    /**
     * Error code from AAD for post request failed error
     */
    AadConstants.POST_REQUEST_FAILED = 'post_request_failed';
    /**
     * Error code from AAD for session does not exist error
     */
    AadConstants.SESSION_DOES_NOT_EXIST_ERROR = 'AADSTS160021';
    /**
     * Set of error codes that can be resolved by a full page redirect to Azure AD.
    ...
    /**
     * This string contains the ID of the Microsoft Teams AAD Application
     * , which is the same across all tenants
     */
    AadConstants.MICROSOFT_TEAMS_ID = '1fec8e78-bce4-4aaf-ab1b-5451cc387264';
    /**
     * This string contains the ID of the Microsoft Teams Web AAD Application
     * , which is the same across all tenants
     */
    AadConstants.MICROSOFT_TEAMS_WEB_ID = '5e3ce6c0-2b1f-4285-8d4b-75ee78787346';
    /**
    ...
    /**
     * This string contains the app id of the first party SP Framework AAD Helper
     */
    AadConstants.SPO_FIRST_PARTY_APP_HELPER_ID = 'e29b5c86-b9ab-4a86-9a20-d10842007599';
    return AadConstants;
}());
exports.default = AadConstants;
//# sourceMappingURL=AadConstants.js.map