...
exports.InternalAadTokenProvider = exports.PopupEventArgs = exports.TokenAcquisitionEventArgs = exports.BeforeRedirectEventArgs = void 0;
...
var AadTokenProvider = /** @class */ (function () {
    ...
    AadTokenProvider.prototype._setSupportsNestedAppAuth = function (isNAASupported) {
        if (!(0, AadKillSwitches_1.isLogNaaDisabledSActivated)() && !isNAASupported && this._aadConfiguration.isNaaSupported) {
            var disableNaaQosMonitor = new sp_diagnostics_1._QosMonitor('AadTokenProvider.naaDisabled');
    ...
    AadTokenProvider.prototype._ensureState = function () {
        ...
        if ((0, AadKillSwitches_1.isEnsureStateOnNAAKSActivated)() || !((_a = this._aadConfiguration) === null || _a === void 0 ? void 0 : _a.isNaaSupported)) {
            return this._ensureTelemetry().then(function () {
                var hasRedirectedRecently = (0, AadKillSwitches_1.isAllowFullPageRedirectFromEnsureAfterFiveMinutesKsActivated)()
                ...
                if (!(0, AadKillSwitches_1.isAlwaysCallEnsureStateActivated)() || !hasRedirectedRecently) {
                    ...
                    var redirectHandler_1 = function (redirectEvent) {
                        if (!(0, AadKillSwitches_1.isAlwaysCallEnsureStateActivated)() && hasRedirectedRecently) {
                            ...
                            if (!(0, AadKillSwitches_1.isAllowFullPageRedirectFromEnsureAfterFiveMinutesKsActivated)()) {
                                var cancelRedirectQos = new sp_diagnostics_1._QosMonitor('AadTokenProvider.ensureStateRedirectCancelled');
...
var InternalAadTokenProvider = /** @class */ (function (_super) {
    tslib_1.__extends(InternalAadTokenProvider, _super);
    function InternalAadTokenProvider() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return InternalAadTokenProvider;
}(AadTokenProvider));
exports.InternalAadTokenProvider = InternalAadTokenProvider;
