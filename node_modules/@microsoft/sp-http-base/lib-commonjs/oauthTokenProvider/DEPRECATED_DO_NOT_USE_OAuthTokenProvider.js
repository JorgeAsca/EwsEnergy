...
var DEPRECATED_DO_NOT_USE_OAuthTokenProvider = /** @class */ (function () {
    ...
    DEPRECATED_DO_NOT_USE_OAuthTokenProvider.prototype._getTokenUtility = function () {
        ...
        if (!this._tokenUtility) {
            this._tokenUtility = Promise.resolve().then(function () { return tslib_1.__importStar(require('@msinternal/sp-client-shared' /* webpackChunkName: 'ms-client-shared' */)); }).then(function (msClientSharedModule) {
