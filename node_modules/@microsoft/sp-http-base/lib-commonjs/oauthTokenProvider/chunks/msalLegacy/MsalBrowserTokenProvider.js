...
var msal_browser_legacy_1p_1 = require("@azure/msal-browser-legacy-1p");
...
var MsalBrowserTokenProvider = /** @class */ (function () {
        ...
        if (!this._ensureStateResult) {
            ...
            if (!(0, AadKillSwitches_1.isEnsureStateBeforeInitializeBrokerKSActivated)()) {
                ...
                this._ensureStateResult = this._ensureStateHelper()
                    ...
                    if (error.name === 'Canceled' || (error instanceof msal_browser_legacy_1p_1.AuthError && _this._isExpectedFailure(error))) {
    ...
    MsalBrowserTokenProvider.prototype._generateSilentRequest = function (requestContext) {
        ...
        var silentRequestData = tslib_1.__assign(tslib_1.__assign({ account: this._getCurrentAccount(), authority: this._getAuthority(), correlationId: correlationId, scopes: scopes || this._getScopes(resourceEndpoint) }, (useCachedToken ? {} : { cacheLookupPolicy: msal_browser_legacy_1p_1.CacheLookupPolicy.RefreshTokenAndNetwork })), (claims ? { claims: claims } : {}));
        if (!(0, AadKillSwitches_1.isUpdateQosCorrelationIdKsActivated)()) {
    ...
    MsalBrowserTokenProvider.prototype._isInteractionRequiredError = function (error) {
        return (error instanceof msal_browser_legacy_1p_1.InteractionRequiredAuthError ||
    ...
    MsalBrowserTokenProvider.prototype._getAuthenticationScheme = function (authenticationScheme) {
        ...
        if (authenticationScheme === ITokenProvider_1.IAuthenticationScheme.BEARER) {
            authScheme = msal_browser_legacy_1p_1.AuthenticationScheme.BEARER;
        }
        else {
            authScheme = msal_browser_legacy_1p_1.AuthenticationScheme.POP;
        }
        return authScheme;
    };
