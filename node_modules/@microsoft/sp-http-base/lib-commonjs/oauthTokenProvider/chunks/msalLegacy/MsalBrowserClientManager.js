...
var MsalBrowserClientManager = /** @class */ (function () {
    ...
    MsalBrowserClientManager._createMsalBrowserClient = function (authority, clientId, redirectUri) {
        ...
        return new msal_browser_legacy_1p_1.PublicClientApplication(configuration);
    };
    MsalBrowserClientManager._createMsalBrowserNextClient = function (authority, clientId, redirectUri) {
        ...
        return (0, msal_browser_legacy_1p_1.createNestablePublicClientApplication)(configuration);
    };
    MsalBrowserClientManager._createMsalBrowserPairwiseBrokerClient = function (authority, clientId, redirectUri, isNaaSupported, ensureStatePromise) {
        ...
        var brokerConfig = {
            actAsBroker: true,
            preferredInteractionType: msal_browser_legacy_1p_1.InteractionType.Popup
        };
        /**
         ...
         */
        if ((0, AadKillSwitches_1.isAddClientCapabilitiesToMsalConfigKSActivated)() && msalConfiguration && msalConfiguration.auth) {
            msalConfiguration.auth.clientCapabilities = ['CP1'];
        }
        var pwbApp = new msal_browser_legacy_1p_1.PairwiseBrokerApplication(msalConfiguration, brokerConfig);
    ...
    MsalBrowserClientManager._getMsalBrowserConfiguration = function (authority, clientId, redirectUri, isNaaSupported) {
        ...
        if ((0, MsalUtilities_1.shouldPrintMsalLogsToConsole)() && configuration.system) {
            configuration.system.loggerOptions = {
                ...
                logLevel: msal_browser_legacy_1p_1.LogLevel.Verbose
            };
        }
