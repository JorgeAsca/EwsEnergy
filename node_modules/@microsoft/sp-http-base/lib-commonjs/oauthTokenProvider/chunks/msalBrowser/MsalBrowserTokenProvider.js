...
var MsalBrowserTokenProvider = /** @class */ (function () {
    ...
    MsalBrowserTokenProvider.prototype.getTokenData = function (resourceEndpoint, optionsOrUseCachedToken, skipLoggingAndDisableRedirects) {
        ...
        var getTokenQosName = !(0, AadKillSwitches_1.isGetTokenDataQoSNewNameKSActivated)()
            ? 'MsalBrowserV3TokenProvider.GetTokenDataPublic'
            : 'MsalBrowserV3TokenProvider.getTokenData';
        var getTokenDataMonitor = new sp_diagnostics_1._QosMonitor(getTokenQosName);
    ...
    MsalBrowserTokenProvider.prototype._ensureState = function () {
        ...
        if (!this._ensureStateResult) {
            var ensureStateMonitor_1 = new sp_diagnostics_1._QosMonitor('MsalBrowserV3TokenProvider.EnsureState');
            if (!(0, AadKillSwitches_1.isEnsureStateBeforeInitializeBrokerKSActivated)()) {
                this._logger('_ensureState', 'Starting ensure state');
                this._ensureStateResult = this._ensureStateHelper()
                    .catch(function (error) {
                    if (!(0, AadKillSwitches_1.isAlwaysInitializeBrokerKsActivated)() &&
                    ...
                    var isPopupOrCanceledError = !(0, AadKillSwitches_1.isTreatPopupErrorsAsExpectedInEnsureStateKsActivated)() &&
                        (errorMessage.includes('popup_window_error') || errorMessage.includes('Canceled'));
                    if (error.name === 'Canceled' ||
                        isPopupOrCanceledError ||
                        (error instanceof msal_browser_1p_1.AuthError && _this._isExpectedFailure(error))) {
    ...
    MsalBrowserTokenProvider.prototype._ensureTelemetry = function () {
        try {
            if (window.sessionStorage.getItem(MsalRedirectManager_1.CURRENT_REDIRECT_START_TIME_SESSION_STORAGE_KEY)) {
    ...
    MsalBrowserTokenProvider.prototype._initializeBrokering = function () {
        var _this = this;
        var initializeBrokeringMonitor = new sp_diagnostics_1._QosMonitor('MsalBrowserV3TokenProvider.InitializeBrokering');
        var extraData = {
            alias: 'false', // Alias column is used to mark cache hits
            CorrelationId: sp_core_library_1.Guid.newGuid().toString(),
            isInternal: true,
            aadCorrelationId: sp_core_library_1.Guid.newGuid().toString()
        };
        this._logger('_ensureState', 'Initializing pairwise brokering after ensuring state');
        return MsalBrowserClientManager_1.MsalBrowserClientManager.getMsalBrowserClient(this._getAuthority(), this._getClientId(), this._getRedirectUri(), this._defaultConfiguration.isNaaSupported ? true : false, this._defaultConfiguration.isPairwiseBrokerEnabled ? true : false)
            .then(function (clientApp) {
            return !(0, AadKillSwitches_1.isUpdateQosCorrelationIdKsActivated)()
    ...
    MsalBrowserTokenProvider.prototype._ensureStateHelper = function () {
        ...
        try {
            ...
            if ((0, AadFlights_1.isProcessEarCookieClienSideEnabled)()) {
                ...
                if (spa_rt_1.spa_rt) {
                    ...
                    if (!(0, AadKillSwitches_1.isUpdateQosCorrelationIdKsActivated)()) {
                        requestContext_2.telemetryData.aadCorrelationId = sp_core_library_1.Guid.newGuid().toString();
                    }
                    if (!processedExpirationTime ||
                        (!(0, AadKillSwitches_1.isEnsureStateWithGraphIfEARNotAvailableKSActivated)() &&
            ...
            if (!(0, AadKillSwitches_1.isEnsureStateWithGraphIfEARNotAvailableKSActivated)() &&
                !earCookieProcessed &&
                ...
                switch (_b.label) {
                    ...
                    case 3:
                        shouldCreateNAAMonitor = !!this._defaultConfiguration.isNaaSupported &&
                            this._defaultConfiguration.servicePrincipalId === AadConstants_1.default.PRE_AUTHORIZED_APP_PRINCIPAL_ID;
                        isNAAMobile = ((0, AadFlights_1.isNaaFlightEnabledForSharePointMobile)() && sp_core_library_1._BrowserUtilities.isMobileWebView()) ||
                        ...
                        getTokenDataMonitor = new sp_diagnostics_1._QosMonitor(getTokenDataMonitorName);
                        handleSilentAuth = function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            var tokenData, acquireTokenSilentMonitor, ssoSilentMonitor;
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (!this._isCurrentUserLoggedInToMsal()) return [3 /*break*/, 2];
                                        acquireTokenSilentMonitor = new sp_diagnostics_1._QosMonitor('MsalBrowserV3TokenProvider.AcquireTokenSilent');
                                    ...
                                    case 1:
                                        ...
                                        return [3 /*break*/, 4];
                                    case 2:
                                        ssoSilentMonitor = new sp_diagnostics_1._QosMonitor('MsalBrowserV3TokenProvider.SsoSilent');
                        ...
                        handlePopupAuth = function (error) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            ...
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        if (!((0, MsalUtilities_1.shouldUsePopupDebug)() || (this._shouldUsePopup() && this._isInteractionRequiredError(error)))) return [3 /*break*/, 4];
                                        popupMonitor = new sp_diagnostics_1._QosMonitor('MsalBrowserV3TokenProvider.Popup');
                        ...
                        handleRedirectAuth = function (error) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            var isTopFrame, canRedirect, conditionalAcccessPolicyHitDuringEnsureState, monitorTimeoutFailure;
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        isTopFrame = (0, AadKillSwitches_1.isInteractionRequiredInIFrameExpectedKsActivated)() || window.top === window.self;
                                        ...
                                        if (canRedirect &&
                                            ...
                                            canRedirect = false;
                                            conditionalAcccessPolicyHitDuringEnsureState = new sp_diagnostics_1._QosMonitor('MsalBrowserV3TokenProvider.ConditionalAccessDuringEnsureState');
                                    ...
                                    case 7:
                                        monitorTimeoutFailure = new sp_diagnostics_1._QosMonitor('MsalBrowserV3TokenProvider.MonitorWindowTimeout');
                        ...
                        _loop_1 = function () {
                            ...
                            return tslib_1.__generator(this, function (_d) {
                                switch (_d.label) {
                                    case 0:
                                        _d.trys.push([0, 2, , 12]);
                                        if ((0, MsalUtilities_1.shouldUsePopupDebug)()) {
    ...
    MsalBrowserTokenProvider.prototype._acquireTokenSilent = function (requestContext, acquireTokenSilentMonitor, attempt) {
        ...
        return this._msalBrowserClient
            ...
            else if ((0, AadKillSwitches_1.isUpdateQosCorrelationIdKsActivated)()) {
    ...
    MsalBrowserTokenProvider.prototype._acquireTokenPopup = function (requestContext, popupMonitor) {
        ...
        sp_core_library_1._SPEventManager.instance.raiseEvent(AadTokenProvider_1.default._popupEventId, new AadTokenProvider_1.PopupEventArgs(cancel, requestPopup, showPopup, resourceEndpoint, {
    ...
    MsalBrowserTokenProvider.prototype._generateSilentRequest = function (requestContext) {
        ...
        var silentRequestData = tslib_1.__assign(tslib_1.__assign({ account: this._getCurrentAccount(), authority: this._getAuthority(), correlationId: correlationId, scopes: scopes || this._getScopes(resourceEndpoint) }, (useCachedToken ? {} : { cacheLookupPolicy: msal_browser_1p_1.CacheLookupPolicy.RefreshTokenAndNetwork })), (claims ? { claims: claims } : {}));
        if (!(0, AadKillSwitches_1.isUpdateQosCorrelationIdKsActivated)()) {
            silentRequestData.correlationId = sp_core_library_1.Guid.newGuid().toString();
        }
    ...
    MsalBrowserTokenProvider.prototype._generateSsoSilentRequest = function (requestContext) {
        ...
        var ssoSilentRequestData = tslib_1.__assign({ authority: this._getAuthority(), correlationId: correlationId, scopes: scopes || this._getScopes(resourceEndpoint) }, (claims
            ...
            : {}));
        if (!(0, AadKillSwitches_1.isUpdateQosCorrelationIdKsActivated)()) {
            ssoSilentRequestData.correlationId = sp_core_library_1.Guid.newGuid().toString();
        }
    ...
    MsalBrowserTokenProvider.prototype._generatePopupRequest = function (requestContext) {
        ...
        var popupRequestData = tslib_1.__assign({ account: this._getCurrentAccount(), authority: this._getAuthority(), correlationId: correlationId, scopes: scopes || this._getScopes(resourceEndpoint) }, (claims
            ...
            : {}));
        if (!(0, AadKillSwitches_1.isUpdateQosCorrelationIdKsActivated)()) {
            popupRequestData.correlationId = sp_core_library_1.Guid.newGuid().toString();
        }
    ...
    MsalBrowserTokenProvider.prototype._generateLoginRedirectRequest = function (requestContext) {
        ...
        if (!(0, AadKillSwitches_1.isUpdateQosCorrelationIdKsActivated)()) {
            redirectRequestData.correlationId = sp_core_library_1.Guid.newGuid().toString();
        }
        if (!(0, AadKillSwitches_1.isLogFullPageRedirectCorrelationIdKsActivated)()) {
            requestContext.telemetryData.aadCorrelationId = redirectRequestData.correlationId;
        }
        if (!(0, AadKillSwitches_1.isUseLoginHintForRedirectKsActivated)()) {
    ...
    MsalBrowserTokenProvider.prototype._getOnRedirectNavigate = function (requestContext) {
        ...
        var onRedirectNavigateCallback = function (url) {
            ...
            if (_this._redirectCancelled) {
                ...
                var handleFiveDayRedirectLogging = !(0, AadKillSwitches_1.isHandleFiveDayRedirectLoggingKsActivated)();
    ...
    MsalBrowserTokenProvider.prototype._getCurrentAccount = function () {
        ...
        if (currentAccountByUsername || currentAccountByLocalId) {
            ...
            if (userName || localId) {
                if (!(0, AadKillSwitches_1.isHandleAccountSwitchKsActivated)() && currentActiveAccount) {
                    ...
                    var userSwitchQos = new sp_diagnostics_1._QosMonitor('MsalBrowserV3TokenProvider.UserSwitchDetected', true, true);
    ...
    MsalBrowserTokenProvider.prototype._isRetriableNetworkError = function (error) {
        return (AadErrorHandler_1.AadErrorHandler._isTokenRenewalTimeout(error === null || error === void 0 ? void 0 : error.errorCode) ||
            AadErrorHandler_1.AadErrorHandler._isPostRequestFailedError(error === null || error === void 0 ? void 0 : error.errorCode));
    };
    /**
