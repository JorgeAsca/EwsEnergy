...
exports.MsalRedirectManager = exports.CORRELATION_ID_SESSION_STORAGE_KEY = exports.CURRENT_REDIRECT_START_TIME_SESSION_STORAGE_KEY = void 0;
exports.CURRENT_REDIRECT_START_TIME_SESSION_STORAGE_KEY = 'spfx.msal.currentRedirectStartTime';
exports.CORRELATION_ID_SESSION_STORAGE_KEY = 'spfx.msal.correlationId';
/**
 ...
 * Note that a maximum of 2 redirect attempts may be tried in 1 minute.
 *
...
var MsalRedirectManager = /** @class */ (function () {
    ...
    function MsalRedirectManager(authority, clientId, shouldUseMsalBrowser) {
        this._STORAGE_KEYS = {
            ...
            CURRENT_REDIRECT_START_TIME: exports.CURRENT_REDIRECT_START_TIME_SESSION_STORAGE_KEY,
            CORRELATION_ID: exports.CORRELATION_ID_SESSION_STORAGE_KEY,
            MSAL_V422_OVERRIDE: 'spfx.msalv422.override'
        };
    ...
    MsalRedirectManager.prototype.isRedirectInProgress = function () {
        var hasAttemptedRedirectInLastMinute = this.getCurrentNumberOfRedirectAttempts() > 0;
        return hasAttemptedRedirectInLastMinute && MsalRedirectManager._isRedirectInProgress;
    };
    /**
     ...
     */
    MsalRedirectManager.prototype.prepareForRedirect = function (correlationId) {
        MsalRedirectManager._isRedirectInProgress = true;
        window.sessionStorage.setItem(this._STORAGE_KEYS.IS_REDIRECT_IN_PROGRESS, 'true');
        window.sessionStorage.setItem(this._STORAGE_KEYS.MSAL_V422_OVERRIDE, 'true');
        ...
        if (!this._shouldUseMsalBrowser) {
            window.sessionStorage.setItem(this._STORAGE_KEYS.V1_CLIENT_ID, this._clientId);
        }
        this._setCurrentRedirectTimeInSessionStorage();
        window.sessionStorage.setItem(this._STORAGE_KEYS.CORRELATION_ID, correlationId || '');
    };
    /**
    ...
    MsalRedirectManager.prototype.cancelRedirect = function () {
        ...
        MsalRedirectManager._isRedirectInProgress = false;
    };
    /**
    ...
    MsalRedirectManager.prototype.getCurrentNumberOfRedirectAttempts = function () {
        ...
        var maxRedirectTimeInMs = MsalRedirectManager._MAX_REDIRECT_TIME_IN_MIN * oneMinInMs;
    ...
    /**
     * Creates a date object capturing the current time while on the current redirect attempt and saves it to session storage as the start time
     * of the current redirect attempt.
     */
    MsalRedirectManager.prototype._setCurrentRedirectTimeInSessionStorage = function () {
        var currentDate = new Date();
        window.sessionStorage.setItem(this._STORAGE_KEYS.CURRENT_REDIRECT_START_TIME, currentDate.toString());
    };
    MsalRedirectManager._ALLOWED_REDIRECT_ATTEMPTS = 2;
