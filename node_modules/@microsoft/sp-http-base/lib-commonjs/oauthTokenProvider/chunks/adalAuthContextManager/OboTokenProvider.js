...
var utilities_jwt_1 = require("@msinternal/utilities-jwt");
...
var OboTokenProvider = /** @class */ (function () {
            ...
            if (_this._oboFirstPartyTokenCallback) {
                if (!_this._oboFirstPartyTokenRequest || refresh) {
                    _this._oboFirstPartyTokenRequest = _this._oboFirstPartyTokenCallback(claims, refresh)
                        ...
                        if (!(0, AadKillSwitches_1.isHandleClaimsChallengeOn1p3pExchangeFailureKSActivated)()) {
    ...
    OboTokenProvider.prototype.getToken = function (resourceEndpoint, optionsOrUseCachedToken) {
        ...
        return this._getAccessToken(resourceEndpoint, useCachedToken, claims)
            ...
            if (!sp_core_library_1._SPKillSwitch.isActivated('cbb2a51c-1456-49ee-92ca-adde5d7e70c7'
    ...
    OboTokenProvider.prototype._getOboAuthToken = function (claims, refresh) {
        ...
        if (clientId === AadConstants_1.default.PRE_AUTHORIZED_APP_PRINCIPAL_ID && this._oboFirstPartyTokenCallback) {
            ...
            (sp_core_library_1._SPKillSwitch.isActivated('1281dd06-6176-4d48-ad3c-9442e8294985'
            /* '01/13/2022',
        ...
        return retVal
            ...
            if (_this._isTokenExpired(token, extraLogData)) {
                ...
                sp_core_library_1._SPKillSwitch.isActivated('cbe07593-122d-4ed8-9a3c-ec1944b9bcfa'
                /* '10/26/2022',
    ...
    extraLogData, claims) {
        ...
        return this._getOboAuthToken(claims).then(function (oboAuthToken) {
            if (_this._authContext.config.clientId === AadConstants_1.default.PRE_AUTHORIZED_ISOLATED_APP_PRINCIPAL_ID) {
    ...
    extraLogData, claims) {
        ...
        requestInfo.headers = tslib_1.__assign(tslib_1.__assign({}, requestInfo.headers), { ClientId: this._authContext.config.clientId, Resource: resourceEndpoint });
        return this._spHttpClient.get(urlToCall, SPHttpClient_1.default.configurations.v1, requestInfo).then(function (response) {
            return _this._handleOboResponse(response, resourceEndpoint, extraLogData, claims);
        });
    };
            ...
            if (response.status === 401) {
                ...
                if (!claims && authenticateHeader) {
                    ...
                    /* '08/08/2022',
                        ...
                        requiredClaims = sp_core_library_1._ResponseUtilities.getRequiredClaims(authenticateHeader);
                    }
                    else {
