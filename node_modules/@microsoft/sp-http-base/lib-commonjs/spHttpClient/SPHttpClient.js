...
var DeferredCookieRefresher_1 = require("./DeferredCookieRefresher");
/**
...
var SPHttpClient = /** @class */ (function () {
    function SPHttpClient(serviceScope) {
        ...
        this._serviceScope.whenFinished(function () {
            ...
            _this._cookieRefresher = _this._serviceScope.consume(DeferredCookieRefresher_1.DeferredCookieRefresher.serviceKey);
        });
        this.onBeforeRedirectEvent = new sp_core_library_1.SPEvent(SPHttpClient._onBeforeRedirectEventId);
        this.onPopupRequestedEvent = new sp_core_library_1.SPEvent(SPHttpClient._onPopupRequestedEventId);
    ...
    SPHttpClient.prototype._fetch = function (url, configuration, options) {
        ...
        return SPHttpClientHelper_1.default.fetchCore(url, configuration, options, this._serviceScope, this._digestCache, this._fetchProvider, this._cookieRefresher, this._logSourceId, originalCorrelationId);
    };
    ...
    SPHttpClient._onBeforeRedirectEventId = 'onBeforeFullPageRedirect';
    SPHttpClient._onPopupRequestedEventId = 'authPopup';
    return SPHttpClient;
}());
