...
var SPHttpClientConfiguration = /** @class */ (function (_super) {
    ...
    Object.defineProperty(SPHttpClientConfiguration.prototype, "usePopupForCookieRefresh", {
        /**
         * {@inheritDoc ISPHttpClientConfiguration.usePopupForCookieRefresh}
         */
        get: function () {
            var _a;
            return (_a = this.flags.usePopupForCookieRefresh) !== null && _a !== void 0 ? _a : false;
        },
        enumerable: false,
        configurable: true
    });
