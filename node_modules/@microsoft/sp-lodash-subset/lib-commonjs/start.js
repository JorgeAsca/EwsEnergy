...
const _spfxinternalheftplugins = require("@msinternal/spfx-internal-heft-plugins");
...
async function runAsync(options) {
    ...
    try {
        ...
        const outputHash = _nodecrypto.default.createHash('md5').update(compiledOutput).digest('hex').substring(0, 20);
