...
import type { DynamicDataProvider } from '@microsoft/sp-component-base';
import type { Guid } from '@microsoft/sp-core-library';
import type { IFilePickerData } from '@msinternal/sp-filepicker-interfaces';
import type { IRenderFunction } from '@fluentui/react';
import type { ISelectableOption } from '@fluentui/react';
import type { ISPPagesContentPanelCommand } from '@msinternal/sp-pages-content-panel-context';
import type { IStockReportingData } from '@msinternal/sp-component-utilities';
import * as React_2 from 'react';
import type { ReactElement } from 'react';
import type { ServiceScope } from '@microsoft/sp-core-library';
import type { SPPagesContentPanelCommandId } from '@msinternal/sp-pages-content-panel-context';

/* Excluded from this release type: _ConfigurableOptionsController */

/* Excluded from this release type: _DeferredPropertyPane */
...
/* Excluded from this release type: _getPropertyPaneHeadingLevelDropdownProperties */

/* Excluded from this release type: _IAudiencePickerPosition */

/* Excluded from this release type: _IConfigurableOptionsController */

/* Excluded from this release type: _IConfigurationToolsLoaderData */

/* Excluded from this release type: _IConfiguredDynamicTextFieldProps */
...
/* Excluded from this release type: IFilePickerData */
...
/* Excluded from this release type: _ILanguageOption */

/* Excluded from this release type: _ILifeCycleEventCallback */
...
/* Excluded from this release type: _IMenuItemProps */
...
/* Excluded from this release type: _IPropertyPaneAlternativeTextProps */
...
export declare interface IPropertyPaneButtonProps {
     ...
     * control back to the web part, so that web part can make act accordingly.
     *
...
/* Excluded from this release type: _IPropertyPaneColumns */

/* Excluded from this release type: _IPropertyPaneCommandData */
...
export declare interface IPropertyPaneConfiguration {
    ...
    /**
     * Type of pages to be displayed on the PropertyPane.
     * By default, it works as 'Pages' for multi pages property pane.
     *
     * @beta
     */
    pagesType?: PagesType;
    ...
    /* Excluded from this release type: audiencePickerPosition */
    /* Excluded from this release type: hideTitleBar */
    /* Excluded from this release type: customFooter */
    /* Excluded from this release type: customHeader */
    /* Excluded from this release type: showBackButton */
    /* Excluded from this release type: disableVisibilityGroup */
}

/* Excluded from this release type: _IPropertyPaneConfigurationEventCommand */

/* Excluded from this release type: _IPropertyPaneConsumer */

/* Excluded from this release type: _IPropertyPaneControlVisibility */
...
export declare interface IPropertyPaneCustomFieldProps {
     ...
     * @param isValidEntry - Indicates if the new value is valid or not.
     */
...
export declare interface IPropertyPaneDropdownProps {
    ...
    /* Excluded from this release type: onRenderOption */
}
...
/* Excluded from this release type: _IPropertyPaneEventArgs */
...
/* Excluded from this release type: _IPropertyPaneFieldChangeCommand */

/* Excluded from this release type: _IPropertyPaneFieldTooltipProps */
 ...
 * @beta
 */
export declare interface IPropertyPaneHeadingProps {
    /**
...
export declare interface IPropertyPaneIconPickerProps {
     ...
     */
    onItemDeleted?: () => void;
    /* Excluded from this release type: _extendedIcons */
    /**
     * If specified, disables the action buttons so icons cannot be selected or changed.
     */
    disabled?: boolean;
}
...
/* Excluded from this release type: _IPropertyPaneLanguageDropdownInternalProps */

/* Excluded from this release type: _IPropertyPaneLanguageDropdownProps */
...
/* Excluded from this release type: _IPropertyPaneMotionToggleProps */
...
export declare interface IPropertyPanePage {
    ...
    /* Excluded from this release type: columns */
    /* Excluded from this release type: independentColumnScrolling */
}
...
/* Excluded from this release type: _IPropertyPaneProps */
...
/* Excluded from this release type: _IPropertyPaneSortableAccordionActiveItem */

/* Excluded from this release type: _IPropertyPaneSortableAccordionItem */

/* Excluded from this release type: _IPropertyPaneSortableAccordionProps */
...
export declare interface IPropertyPaneTextFieldProps {
    ...
    multiline?: boolean;
    /**
     * Whether or not the text field is read only.
     * @remarks
     * The default value is false.
     */
    readOnly?: boolean;
    ...
    /* Excluded from this release type: _tooltipProps */
}
 ...
 * @beta
 */
export declare interface IPropertyPaneThumbnailPickerProps extends Pick<IFilePickerData, 'enableGettyStockAssets'> {
    /**
     * Service scope.
     */
    ...
    onItemDeleted?: () => void;
    /**
     * Optionally specify if the picker is disabled and cannot be changed.
     */
    disabled?: boolean;
}
...
export declare interface IPropertyPaneToggleProps {
     ...
     * If you are maintaining state yourself, set this property accordingly.
     */
    checked?: boolean;
    /**
     ...
     */
    inlineLabel?: boolean;
    /* Excluded from this release type: postOnChangeCallback */
    /* Excluded from this release type: tooltipProps */
    /* Excluded from this release type: disabledToggleControlTooltipProps */
}

/* Excluded from this release type: _IPropertyPaneToggleTooltipProps */

/* Excluded from this release type: _IPropertyPaneWebPartTitle */

/* Excluded from this release type: _IRefreshPropertyPaneCommand */
 ...
 * @beta
 */
export declare interface IThumbnailImage extends IStockReportingData {
    /**
     * Image type.
     */
...
/**
 * Page display type for multi pages property pane.
 *
 * @beta
 */
export declare enum PagesType {
    /**
     * Show property panes in tab style.
     */
    Tabs = 0,
    /**
     * Show property panes in pagination style.
     */
    Pages = 1
}
...
/* Excluded from this release type: _PropertyPaneAlternativeText */
...
/* Excluded from this release type: _PropertyPaneControlVisibility */

/* Excluded from this release type: _PropertyPaneControlVisibilityGroup */
 ...
 * Temporary solution while waiting for redesign
 ...
 * */
export declare type PropertyPaneHeadingLevel = 'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'h6';
...
/* Excluded from this release type: _PropertyPaneLanguageDropdown */
...
/* Excluded from this release type: _PropertyPaneMotionToggle */
...
/* Excluded from this release type: _PropertyPaneSortableAccordion */
...
/* Excluded from this release type: _PropertyPaneWebPartTitle */

/* Excluded from this release type: _PropertyPaneWidthMode */
...
/* Excluded from this release type: _UpdateGroupData */

/* Excluded from this release type: _UpdateItemData */
