...
import { css, PrimaryButton, getIconClassName } from '@ms/office-ui-fabric-react-bundle';
...
var PropertyPaneFooter = /** @class */ (function (_super) {
    ...
    function PropertyPaneFooter(props) {
        ...
        _this._onBackClick = function () {
            _this.props.onFlipPage(PageDirection.back);
        };
        _this._onNextClick = function () {
            _this.props.onFlipPage(PageDirection.next);
        };
    ...
    PropertyPaneFooter.prototype._renderCommandButtons = function () {
        ...
        return (this.props.isReactive === false && (React.createElement("div", { className: this.props.numberOfPages > 1 ? styles.propertyPaneCommandButtonsBox : undefined },
            React.createElement(PrimaryButton, { "data-automation-id": 'propertyPaneApplyButton', disabled: !this.props.isSaveButtonEnabled, onClick: this.props.onSaveClick, ariaDescription: strings.ApplyButtonAriaDescription }, strings.Save))));
    };
    PropertyPaneFooter.prototype._pageNavigationButtons = function () {
        return (this.props.numberOfPages > 1 && (React.createElement("div", { className: styles.propertyPanePageNav },
            React.createElement("button", { className: styles.propertyPaneBackNavLink, disabled: this.props.currentPage === 1, onClick: this._onBackClick },
            ...
            React.createElement("button", { className: styles.propertyPaneNextNavLink, disabled: this.props.currentPage === this.props.numberOfPages, onClick: this._onNextClick },
