...
import type { IDynamicDataSharedSourceFilters, IDynamicDataSharedPropertyFilters } from '../../propertyPaneDynamicData/IPropertyPaneDynamicDataFilters';
/**
...
export interface IPropertyPaneDynamicFieldComponentBaseProps {
     ...
     */
    onApplyClick: (targetProperty: string, dynamicProperty: DynamicProperty<unknown>) => void;
}
/**
 * @internal
 */
