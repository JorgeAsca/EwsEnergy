import type { IRenderFunction, ISelectableOption } from '@fluentui/react';
import type { IPropertyPaneFieldTooltipProps } from '../propertyPaneField/IPropertyPaneField';
/**
...
export interface IPropertyPaneDropdownProps {
    ...
    /**
     * Props for dropdown's tooltip button, which appears next to the label.
     *
     * @internal
     */
    tooltipProps?: IPropertyPaneDropdownTooltipProps;
    /**
...
/**
 * Props for tooltip that appears when the info button is clicked.
 *
 * @internal
 */
export interface IPropertyPaneDropdownTooltipProps extends IPropertyPaneFieldTooltipProps {
}
