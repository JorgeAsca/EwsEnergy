 ...
 *
 * `BackClicked` Event indicating navigation back.
 * - When user clicks on Back button on Property Pane
 *
 * @internal
 */
export type PropertyPaneLifeCycleEvent = 'ConfigurationStart' | 'ConfigurationComplete' | 'Opened' | 'Closed' | 'ApplyClicked' | 'LostFocus' | 'ActiveWebPartChanged' | 'BackClicked';
/**
