...
import { autobind, Link } from '@ms/office-ui-fabric-react-bundle';
...
var PropertyPaneConditionalGroup = /** @class */ (function (_super) {
    __extends(PropertyPaneConditionalGroup, _super);
    ...
    PropertyPaneConditionalGroup.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            !showSecondaryGroup && (React.createElement(SecondaryGroupConnector, { onConnectToSourceClick: this._onShowSecondaryClick })),
            React.createElement("div", { className: styles.clear }),
            this._renderGroup(),
            showSecondaryGroup && (React.createElement("div", { className: styles.removeConnectionButton },
    ...
    PropertyPaneConditionalGroup.prototype._renderGroup = function () {
        ...
        return (React.createElement(PropertyPaneGroup, __assign({}, this.props, { key: group.groupName || this.props.index, pageNumber: this.props.pageNumber, groupName: group.groupName, groupFields: group.groupFields, onChange: this.props.onChange, properties: this.props.properties, setEntryState: this.props.setEntryState, isCollapsed: group.isCollapsed, displayGroupsAsAccordion: this.props.displayGroupsAsAccordion, propertyPaneGroupStateChanged: this.props.propertyPaneGroupStateChanged, propertyPanePagesStateMap: this.props.propertyPanePagesStateMap, dynamicConfiguration: this.props.dynamicConfiguration })));
    };
    /**
