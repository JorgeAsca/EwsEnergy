import type { IPropertyPanePagesStateMap } from '../propertyPane/PropertyPane';
import type { IDynamicConfiguration } from '../propertyPaneDynamicData/IDynamicConfiguration';
import type { IPropertyPaneGroup } from '../propertyPaneGroup/IPropertyPaneGroup';
/**
...
export interface IPropertyPaneConditionalGroupProps extends IPropertyPaneConditionalGroup {
    /**
     * Index of the current conditions group on the page.
     ...
     */
    propertyPanePagesStateMap: IPropertyPanePagesStateMap;
    /**
     ...
     */
    onChange?: (targetProperty: string, value: unknown) => void;
    /**
