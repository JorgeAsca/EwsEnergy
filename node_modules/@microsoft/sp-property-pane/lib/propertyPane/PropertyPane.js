...
import { VNextThemeWrapper } from '@msinternal/fluentui-staging/lib/theming/vNextTheme/VNextThemeWrapper';
import { DefaultV8ThemeProvider } from '@msinternal/fluentui-neutral-components';
import Compare from '../utils/Compare';
import { PagesType, PropertyPaneWidthMode } from './IPropertyPane';
...
import { css, getTheme, Fabric, FocusTrapZone, KeyCodes, Overlay, Spinner, SpinnerType } from '@ms/office-ui-fabric-react-bundle';
import { getFocusableChildren, getFirstFocusableChild, isKey, KeyCodes as ExtendedKeyCodes } from '../utils/CanvasA11y';
import { isAddTablistToProperyPaneKSActivated, isAddTopMarginForExpandedPropertyPaneKSActivated, isApplyButtonFocusKSActivated, isHideTitleBarKSActivated, isPropertyPaneTabsterEnabledKSActivated } from '../common/KillSwitches';
import { isCardDesignerPlusPlusFlight2Enabled, isDeThemeEnabled, isODSPChatPaneResizeEnabled } from '../common/Flights';
import { isPropertyPaneMultiColumn } from '../utils/MultiColumnHelper';
import { zIndex } from './PropertyPaneConsts';
import { PropertyPaneTabList } from '../propertyPaneTablist/PropertyPaneTabList';
/**
 * Page direction.
 */
...
var PropertyPane = /** @class */ (function (_super) {
    ...
    function PropertyPane(props) {
        ...
        _this._handleBackClick = _this._handleBackClick.bind(_this);
        ...
        _this._onChangeTab = _this._onChangeTab.bind(_this);
        ...
        for (var _i = 0, debounceProperties_1 = debounceProperties; _i < debounceProperties_1.length; _i++) {
            ...
            _this._debounceCallbacks.set(propertyName, debounce(_this._raiseEventImpl, debouncePeriod, { leading: true, trailing: true }));
        }
    ...
    PropertyPane.prototype.render = function () {
        ...
        var hideTitleBar = !isHideTitleBarKSActivated() &&
            this.props.data.configuration &&
            this.props.data.configuration.hideTitleBar;
        var isFluentVNextThemeEnabled = _SPFlight.isEnabled(60803 /* FluentVNextAllSp */) ||
            _SPFlight.isEnabled(60804 /* FluentVNextSpPages */);
        var isDeThemeFlightEnabled = isDeThemeEnabled();
        this._isPropertyPaneExpanded = isCardDesignerPlusPlusFlight2Enabled()
            ? isPropertyPaneMultiColumn(this.props.data.configuration)
            : false;
        var fabricWrapper = (React.createElement(Fabric, { "data-sp-feature-tag": 'Property Pane', "data-sp-feature-instance-id": '_Property Pane' },
            this.state.saveConfirmationMessage && (React.createElement("div", { role: 'alert', "aria-live": 'polite', className: propertyPaneStyles.propertyPaneScreenReaderOnly },
                React.createElement("span", null, this.state.saveConfirmationMessage))),
            React.createElement(FocusTrapZone, { "data-tabster": !isPropertyPaneTabsterEnabledKSActivated() ? '' : undefined, isClickableOutsideFocusTrap: true, forceFocusInsideTrap: false, disabled: this.props.data.configuration.disableFocusTrap },
                React.createElement("div", { className: mergeClasses(this.props.propertyPaneWidthMode === PropertyPaneWidthMode.Narrow
                        ? propertyPaneStyles.propertyPaneNarrow
                        : (isODSPChatPaneResizeEnabled() &&
                            this.props.propertyPaneWidthMode === PropertyPaneWidthMode.Wide) ||
                            this._isPropertyPaneExpanded
                            ? propertyPaneStyles.propertyPaneExpanded
                            : propertyPaneStyles.propertyPane, isDeThemeFlightEnabled && 'deThemePageDetails'), role: 'region', "aria-label": Text.format(strings.UpdatedPropertyPaneAriaLabel, this.props.data.title), "aria-describedby": this._descriptionId, ref: this._propertyPane, onKeyDown: this._onPropertyPaneKeyDown, key: this.props.data.webPartId },
                    showOverlaySpinner && (React.createElement(Overlay, { className: this._isPropertyPaneExpanded
                            ? propertyPaneStyles.propertyPaneExpandedOverlay
                            : propertyPaneStyles.overlay },
                    ...
                    this._isPropertyPaneExpanded && this.props.data.configuration.customHeader,
                    !hideTitleBar && (React.createElement(PropertyPaneTitleBar, { title: this.props.data.title, onClose: this._handleCloseClick, isExpanded: this._isPropertyPaneExpanded, isCustomHeaderPresent: this._isPropertyPaneExpanded && !!this.props.data.configuration.customHeader, showBackButton: !!this.props.data.configuration.showBackButton, onBackClick: this._handleBackClick })),
                    React.createElement("div", null, this._shouldRenderEmptyPage
                        ? this._renderNoConfigurationState()
                        : this._renderPage(hideTitleBar))))));
        var fabricContent = isDeThemeFlightEnabled ? (React.createElement(DefaultV8ThemeProvider, null, fabricWrapper)) : (fabricWrapper);
        return (React.createElement(React.Fragment, null,
            isFluentVNextThemeEnabled && (React.createElement(VNextThemeWrapper, { theme: getTheme() }, fabricContent)),
            !isFluentVNextThemeEnabled && fabricContent));
    };
    /**
    ...
    PropertyPane.prototype._renderNoConfigurationState = function () {
        return (React.createElement("div", null,
            ...
            React.createElement("div", { role: 'alert', "aria-live": 'polite', className: propertyPaneStyles.propertyPaneDescription, "data-automation-id": 'noConfigurationPropertyPane' }, _SPFlight.isEnabled(638 /* MeeDashboard */) && !this.props.data.webPartId
                ? strings.PropertyPaneDeletionStateDescription
                : strings.PropertyPaneEmptyStateDescription)));
    };
    PropertyPane.prototype._onChangeTab = function (index) {
    ...
    PropertyPane.prototype._renderPage = function (hideTitleBar) {
        ...
        var customFooter = isCardDesignerPlusPlusFlight2Enabled() && this.props.data.configuration.customFooter;
        var showTabLayout = !isAddTablistToProperyPaneKSActivated() && this.props.data.configuration.pagesType === PagesType.Tabs;
        return (React.createElement("div", null,
            React.createElement("div", { className: css(classForPropertyPanePageContentBottom, this._isPropertyPaneExpanded
                    ? !isAddTopMarginForExpandedPropertyPaneKSActivated()
                        ? propertyPanePageStyles.propertyPanePageContentExpanded
                        : propertyPanePageStyles.propertyPanePageContentExpandedOld
                    : propertyPanePageStyles.propertyPanePageContent, hideTitleBar ? propertyPanePageStyles.propertyPanePageContentNoTitleBar : ''), "data-automation-id": 'propertyPanePageContent' },
                React.createElement("div", null, this.props.children),
                showTabLayout && (React.createElement(PropertyPaneTabList, { pages: this.props.data.configuration.pages, onChangeTab: this._onChangeTab, currentPage: this.state.currentPage - 1 })),
                React.createElement(PropertyPanePage, __assign({}, this.props.data, { pageNumber: this.state.currentPage, pageDescription: page.header ? page.header.description : '', displayGroupsAsAccordion: page.displayGroupsAsAccordion || false, onChange: this._onChange, propertyGroups: page.groups, propertyColumns: page.columns, properties: this._properties, setEntryState: this._setEntryState, setContainerDiv: this._setContainerDiv, propertyPaneGroupStateChanged: this._propertyPaneGroupStateChanged, propertyPanePagesStateMap: this._propertyPanePagesStateMap, dynamicConfiguration: this.props.data.dynamicConfiguration, isPropertyPaneExpanded: this._isPropertyPaneExpanded, isScrollingEnabled: page.independentColumnScrolling }))),
            !customFooter && (React.createElement(PropertyPaneFooter, { isReactive: this.props.data.isReactive || false, isSaveButtonEnabled: this.state.isSaveButtonEnabled, numberOfPages: showTabLayout ? 0 : ((_b = (_a = this.props.data.configuration) === null || _a === void 0 ? void 0 : _a.pages) === null || _b === void 0 ? void 0 : _b.length) || 0, currentPage: this.state.currentPage, onSaveClick: this._handleSaveClick, onFlipPage: this._flipPage }))));
    };
    ...
    PropertyPane.prototype._handleSaveClick = function () {
        ...
        if (!isApplyButtonFocusKSActivated()) {
            this._setTimeOutForFocus();
        }
    ...
    PropertyPane.prototype._handleBackClick = function () {
        this.props.data.onConfigurationEvent('BackClicked');
    };
    ...
    PropertyPane.prototype._onPropertyPaneKeyDown = function (ev) {
        if (isKey(KeyCodes.escape, ev) && !ev.defaultPrevented) {
            ev.preventDefault();
    ...
    PropertyPane.prototype._focusOnFirstActionableElement = function () {
        ...
        if (propertyPane) {
            ...
            if (firstElement) {
                ...
                (_a = getFirstFocusableChild(this._propertyPane.current)) === null || _a === void 0 ? void 0 : _a.focus();
            }
        }
    };
    /**
    ...
    PropertyPane.prototype._getCssBottomValueForPageContentElement = function () {
        ...
        if (this.props.data.configuration.pagesType === PagesType.Tabs &&
            this.props.data.isReactive &&
            !this.props.data.configuration.customFooter) {
            return;
        }
        ...
        if (isCardDesignerPlusPlusFlight2Enabled() &&
            this.props.data.configuration.customFooter &&
            !pageContentBottom) {
            pageContentBottom = propertyPaneStyles.oneRowFooter;
        }
