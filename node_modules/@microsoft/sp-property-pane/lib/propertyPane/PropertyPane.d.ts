...
import { PropertyPaneWidthMode, type IPropertyPaneData } from './IPropertyPane';
/**
...
export interface IPropertyPaneProps {
    ...
    propertyPaneWidthMode?: PropertyPaneWidthMode;
}
/**
 ...
 */
export interface IPropertyPaneGroupsStateMap {
    [key: string]: boolean;
}
/**
 * A map to maintain the PropertyPaneGroupsState for the PropertyPane pages.
 */
export interface IPropertyPanePagesStateMap {
    [key: string]: IPropertyPaneGroupsStateMap;
}
/**
...
export default class PropertyPane extends React.Component<IPropertyPaneProps, IPropertyPaneState> {
    ...
    private readonly _debounceCallbacks;
    /**
     ...
     */
    UNSAFE_componentWillReceiveProps(props: IPropertyPaneProps): void;
    ...
    private get _descriptionId();
    /**
     * Renders page on the property pane.
     */
    private _renderPage;
    private _setContainerDiv;
    /**
     ...
     */
    private _propertyPaneGroupStateChanged;
    /**
     * Returns if the empty page should be rendered in property pane.
     */
    private get _shouldRenderEmptyPage();
    /**
     ...
     */
    private _flipPage;
    private _setEntryState;
    private _enableSaveButton;
    private _onChange;
    private _handleSaveClick;
    private _handleCloseClick;
    private _handleBackClick;
    private _raiseEventImpl;
    private _raiseEvent;
    private _onPropertyPaneKeyDown;
    /**
    ...
    private get _isManagingFocusBySettings();
    private _focusOnFirstActionableElement;
    /**
...
//# sourceMappingURL=PropertyPane.d.ts.map