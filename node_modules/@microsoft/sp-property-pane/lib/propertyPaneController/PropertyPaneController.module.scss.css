...
[id^=spPropertyPaneContainerNoFlexbox].spPropertyPaneContainer {
  position: absolute;
  top: 50px;
  bottom: 0;
  z-index: 999;
}
[dir=ltr] [id^=spPropertyPaneContainerNoFlexbox].spPropertyPaneContainer {
  right: -340px;
}
[dir=rtl] [id^=spPropertyPaneContainerNoFlexbox].spPropertyPaneContainer {
  left: -340px;
}
