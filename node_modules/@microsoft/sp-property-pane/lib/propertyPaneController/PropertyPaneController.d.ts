...
import type { PropertyPaneAction } from '../propertyPaneDefinitions/PropertyPaneAction';
import type { IInternalConfigurableOptionsController } from '../configurableOptionsController/IInternalConfigurableOptionsController';
/**
 * Class which manages all the interactions between property pane and the property pane consumers, such as web parts.
 *
 * @internal
 */
export default class PropertyPaneController implements IInternalConfigurableOptionsController {
    ...
    private _topControl;
    /**
     * Control data used for rendering width of property pane
     * Narrow width example: Outlook
     * Broad width example: Copilot
     */
    private _paneWidthMode;
    private _propertyPaneChangeListeners;
     ...
     */
    registerOnPropertyPaneFieldChangedListener(instanceId: string, callback: () => void): () => void;
    /**
     ...
     */
    get currentlyConfiguredConsumerId(): string | undefined;
    /**
     ...
     * @internal
     */
    _setAppPagePropertyPaneTopData(topControl: React.ReactElement, title: string): void;
    /**
    ...
    private _removeAllPropertyPaneContainerClasses;
    /**
    ...
    private _isPropertyPaneExpanded;
    private _isPropertyPaneExpandedClassActive;
}
