...
var DynamicDataWidgetEntry = /** @class */ (function (_super) {
    __extends(DynamicDataWidgetEntry, _super);
    ...
    DynamicDataWidgetEntry.prototype.render = function () {
        ...
        if (selectedPropertyId) {
            ...
            while (level < maxDepth && currentPropertyPath) {
    ...
    DynamicDataWidgetEntry.prototype._getDropdownForSubProperty = function (level, propertyPath, selectedKey) {
        ...
        var selectedText = level === 0
            ...
            : Text.format(Strings.DynamicDataPropertiesDropdownLabel, this._parentSelectedKey || this.state.selectedSubPropertyText || this._selectedSubPropertyText);
        ...
        var labelTxt = level === 0 ? Text.format(Strings.DynamicDataPropertiesDropdownLabel, selectedText) : selectedText;
        return (React.createElement("div", { key: key }, options.length > 0 && (React.createElement(Dropdown, { label: labelTxt, 
     ...
     */
    DynamicDataWidgetEntry.prototype._getDropdownOptions = function (propValue, propertyPath, recursiveCall, selectedKey) {
        var _this = this;
        var options = [];
    ...
    DynamicDataWidgetEntry.prototype._getSubPropertyValueObject = function (propertyPath) {
        ...
        this._currentAnnotatedPropertyValue = this.props.selectedSource.getAnnotatedPropertyValue(property);
    ...
    DynamicDataWidgetEntry.prototype._getSubPropertyPath = function () {
        ...
        subPropertyPaths.forEach(function (subPropertyPath) {
            ...
            if (propertyValueObject) {
                ...
                if (propertyValueObject === null || propertyValueObject === void 0 ? void 0 : propertyValueObject.hasOwnProperty(subPropertyPath)) {
