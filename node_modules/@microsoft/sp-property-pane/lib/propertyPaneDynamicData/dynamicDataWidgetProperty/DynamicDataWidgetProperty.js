...
var DynamicDataWidgetProperty = /** @class */ (function (_super) {
    __extends(DynamicDataWidgetProperty, _super);
    ...
    DynamicDataWidgetProperty.prototype._renderPropertyDropdown = function () {
        ...
        return (React.createElement(Dropdown, { label: Text.format(Strings.DynamicDataPropertiesDropdownLabel, this.props.selectedSource.metadata.title), onChanged: this._setSelectedPropertyId, options: this._getPropertyDropdownOptions(), selectedKey: selectedPropertyId, "data-automation-id": 'DynamicDataWidgetSourceProperties' }));
    };
        ...
        this.props.entries.forEach(function (entry) {
            ...
            widgetEntries.push(React.createElement("div", { key: currentKey },
                _this.state.selectedPropertyId &&
                    ...
                    propertyValueDepth !== 0 && React.createElement(Label, { className: Styles.entryLabel }, label),
                React.createElement(DynamicDataWidgetEntry, __assign({}, entry, { parentKey: currentKey, selectedSource: _this.props.selectedSource, selectedPropertyText: _this._selectedPropertyText, selectedPropertyId: _this.state.selectedPropertyId, dynamicDataProvider: _this.props.dynamicDataProvider, onChange: _this.props.onChange, propertyValueDepth: propertyValueDepth }))));
        });
...
//# sourceMappingURL=DynamicDataWidgetProperty.js.map