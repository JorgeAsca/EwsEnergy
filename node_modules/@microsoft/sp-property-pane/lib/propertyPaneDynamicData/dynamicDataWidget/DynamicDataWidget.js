...
var DynamicDataWidget = /** @class */ (function (_super) {
    __extends(DynamicDataWidget, _super);
    ...
    DynamicDataWidget.prototype._renderWidgetSource = function (entries) {
        ...
        return (React.createElement("div", { key: currentKey, className: Styles.dynamicDataWidget },
            entries.length === 1 && React.createElement(Label, { className: Styles.entryLabel }, entries[0].properties.label),
            React.createElement(DynamicDataWidgetSource, __assign({}, this.props, { parentKey: currentKey, entries: entries }))));
    };
