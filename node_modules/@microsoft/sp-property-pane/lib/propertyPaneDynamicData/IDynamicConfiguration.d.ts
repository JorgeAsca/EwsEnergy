...
import type { IDynamicDataSharedSourceFilters, IDynamicDataSharedPropertyFilters } from './IPropertyPaneDynamicDataFilters';
/**
...
export interface IDynamicConfiguration {
     ...
     *
     * @remarks
     * There is only one 'dynamicDataProvider' for a component
     */
     ...
     *
     * @remarks
     * If 'callback' is not supplied for any of the dynamic properties, for both
     * field and property pane level, then this is used as the default.
     *
     * This is a function that wraps the render() function.
 ...
 * @public
 */
export interface IDynamicDataSharedSourceConfiguration {
    /**
 ...
 * @public
 */
export interface IDynamicDataSharedPropertyConfiguration {
    /**
...
//# sourceMappingURL=IDynamicConfiguration.d.ts.map