...
import { autobind, Label, Link } from '@ms/office-ui-fabric-react-bundle';
...
var DynamicDataWidgetSource = /** @class */ (function (_super) {
    __extends(DynamicDataWidgetSource, _super);
    ...
    DynamicDataWidgetSource.prototype._renderSourceDropdown = function () {
        ...
        return (React.createElement("div", null, !sourceIdFilter && (React.createElement("div", null,
            React.createElement(Dropdown, { label: sourceLabel, onChanged: this._setSelectedSourceId, options: dropdownOptions, selectedKey: selectedSourceId, "data-automation-id": 'DynamicDataWidgetSource', errorMessage: showErrorMessage ? strings.NoDataSourceErrorMessage : undefined }),
            showErrorMessage && (React.createElement(Link, { href: 'https://go.microsoft.com/fwlink/?linkid=2117174', target: '_blank' }, strings.LearnMoreLabel))))));
    };
    /**
    ...
    DynamicDataWidgetSource.prototype._renderWidgetProperty = function (counter, entries) {
        ...
        return (React.createElement("div", { key: currentKey },
            this.props.entries.length > 1 && !this._isPropertyShared() && (React.createElement(Label, { className: Styles.entryLabel }, entries[0].properties.label)),
            React.createElement(DynamicDataWidgetProperty, __assign({}, this.props, { parentKey: currentKey, selectedSource: this._selectedSource, entries: entries }))));
    };
    __decorate([
        autobind
