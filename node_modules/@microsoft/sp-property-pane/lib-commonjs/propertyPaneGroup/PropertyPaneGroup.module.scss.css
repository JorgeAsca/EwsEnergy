...
:global(.deThemePageDetails) .propertyPaneGroupHeader {
  border-color: var(--colorNeutralStroke1) transparent transparent transparent;
}
:global(.deThemePageDetails) .propertyPaneGroupHeader:last-of-type:not(:focus) {
  border-bottom-color: var(--colorNeutralStroke1);
}
:global(.deThemePageDetails) .propertyPaneGroupHeader:focus {
  border-color: var(--colorNeutralStrokeAccessible);
}
:global(.deThemePageDetails) .propertyPaneGroupHeader:hover {
...
:global(.deThemePageDetails) .highContrastFocusState:focus::-moz-focus-inner {
  border: 0;
}
:global(.deThemePageDetails) .highContrastFocusState:focus {
  outline: transparent;
  position: relative;
}
:global(.deThemePageDetails) .highContrastFocusState:focus::after {
  content: "";
  position: absolute;
  top: 1px;
  right: 1px;
  ...
  left: 1px;
  pointer-events: none;
  border: 2px solid var(--colorNeutralStrokeAccessible);
}
...
:global(.deThemePageDetails) .propertyPaneGroup:last-child .propertyPaneGroupHeader {
  border-bottom-color: var(--colorNeutralStroke1);
}
...
:global(.deThemePageDetails) .propertyPaneGroupHeaderIcon {
...
:global(.deThemePageDetails) .propertyPaneGroupHeaderNoAccordion,
:global(.deThemePageDetails) .propertyPaneGroupHeader {
  color: unset;
}
...
:global(.deThemePageDetails) .propertyPaneGroupContent h2 {
  color: unset;
}
...
:global(.deThemePageDetails) .propertyPaneChoiceGroupNew :global .themeableSvgPath {
  fill: unset;
}
...
:global(.deThemePageDetails) .propertyPaneChoiceGroupNew :global .themeableSvgStroke {
  stroke: unset;
}
@media screen and (-ms-high-contrast: active), (forced-colors: active) {
  .propertyPaneChoiceGroupNew :global .themeableSvgStroke {
...
.propertyPaneChoiceGroup :global .ms-Label {
  width: 100%;
  box-sizing: border-box;
}
.propertyPaneChoiceGroup :global .ms-ChoiceField--image,
.propertyPaneChoiceGroup :global .ms-ChoiceField--icon {
  height: initial;
  width: calc(33.33% - 4px);
}
.propertyPaneChoiceGroup :global .ms-ChoiceField--image .ms-ChoiceField-field,
.propertyPaneChoiceGroup :global .ms-ChoiceField--icon .ms-ChoiceField-field {
  min-width: 100%;
}
.propertyPaneChoiceGroup :global .ms-ChoiceField--image .ms-ChoiceField-innerField,
.propertyPaneChoiceGroup :global .ms-ChoiceField--icon .ms-ChoiceField-innerField {
  align-items: center;
  display: flex;
  height: 52px;
  justify-content: center;
}
.propertyPaneChoiceGroup :global .ms-ChoiceField--image .ms-ChoiceField-labelWrapper,
.propertyPaneChoiceGroup :global .ms-ChoiceField--icon .ms-ChoiceField-labelWrapper {
  margin-bottom: 8px;
}
.propertyPaneChoiceGroup :global .ms-ChoiceField-wrapper {
  width: 100%;
}
.propertyPaneChoiceGroup :global .themeableSvgPath {
  fill: "[theme:neutralPrimary, default: #323130]";
}
:global(.deThemePageDetails) .propertyPaneChoiceGroup :global .themeableSvgPath {
  fill: unset;
}
.propertyPaneChoiceGroup :global .ms-ChoiceFieldGroup-flexContainer {
  width: 100%;
}

.propertyPaneChoiceGroup :global .ms-ChoiceField--title .ms-Label {
  color: "[theme:neutralPrimary, default: #323130]";
}
:global(.deThemePageDetails) .propertyPaneChoiceGroup :global .ms-ChoiceField--title .ms-Label {
  color: unset;
}
...
:global(.deThemePageDetails) .propertyPaneGroupField :global .contrastRatio-overwrite .ms-TextField-fieldGroup:enabled {
  border-color: var(--colorNeutralStroke2);
}
:global(.deThemePageDetails) .propertyPaneGroupField :global .contrastRatio-overwrite .ms-TextField-fieldGroup:hover[enabled] {
...
:global(.deThemePageDetails) .propertyPaneGroupField {
  color: unset;
}
:global(.deThemePageDetails) .propertyPaneGroupField h4 {
  color: unset;
}
