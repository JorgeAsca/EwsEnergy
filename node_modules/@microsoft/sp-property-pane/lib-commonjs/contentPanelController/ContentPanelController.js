...
var PropertyPaneFieldChangeListeners_1 = require("../propertyPaneController/PropertyPaneFieldChangeListeners");
/**
 * @internal
 */
var ContentPanelController = /** @class */ (function () {
    ...
    ContentPanelController.prototype.registerOnPropertyPaneFieldChangedListener = function (instanceId, callback) {
        return !(0, KillSwitches_1.isLeverageContentPanelForTopActionUpdatesKSActivated)()
            ? this._propertyPaneChangeListeners.register(instanceId, callback)
            : function () { };
    };
            ...
            case 'Refresh':
                if (!(0, KillSwitches_1.isLeverageContentPanelForTopActionUpdatesKSActivated)()) {
                    if (!(0, KillSwitches_1.isDispatchAllPropertyListenersKSActivated)()) {
                        ...
                        this._propertyPaneChangeListeners.dispatch(toBeConfiguredConsumerId);
                    }
                }
                if (this.isOpen() &&
                    ((0, Flights_1.isPageDetailsEnabled)()
    ...
    ContentPanelController.prototype.isComponentSupported = function (instanceId, consumer) {
        ...
        // webparts
        if ((0, Flights_1.isContentPanelV2Enabled)()) {
        ...
        if (consumer) {
            if (!(0, KillSwitches_1.isLeverageContentPanelForTopActionUpdatesKSActivated)()) {
                if (!(0, KillSwitches_1.isDispatchAllPropertyListenersKSActivated)()) {
                    ...
                    this._propertyPaneChangeListeners.dispatch(this._currentlyConfiguredConsumerId);
                }
            }
                        ...
                        subscriberContext.setLoader((0, Flights_1.isPageDetailsEnabled)()
                            ...
                            return propertyPaneConsumer === null || propertyPaneConsumer === void 0 ? void 0 : propertyPaneConsumer._getPropertyPaneData.apply(propertyPaneConsumer, args).then(function (propertyPaneData) {
                                ...
                                return {
                                    ...
                                    componentId: componentId,
                                    paneWidthMode: _this._paneWidthMode,
