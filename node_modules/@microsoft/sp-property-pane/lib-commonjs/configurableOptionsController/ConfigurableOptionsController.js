...
var ConfigurableOptionsController = /** @class */ (function () {
    ...
    ConfigurableOptionsController.prototype.registerOnPropertyPaneFieldChangedListener = function (instanceId, callback) {
        ...
        var unregisterForPropertyPaneController = this._propertyPaneController.registerOnPropertyPaneFieldChangedListener(instanceId, callback);
        var unregisterForContentPanelController = (_a = this._contentPanelController) === null || _a === void 0 ? void 0 : _a.registerOnPropertyPaneFieldChangedListener(instanceId, callback);
        return function () {
            unregisterForPropertyPaneController();
            unregisterForContentPanelController === null || unregisterForContentPanelController === void 0 ? void 0 : unregisterForContentPanelController();
        };
    };
