...
var VNextThemeWrapper_1 = require("@msinternal/fluentui-staging/lib/theming/vNextTheme/VNextThemeWrapper");
var fluentui_neutral_components_1 = require("@msinternal/fluentui-neutral-components");
var Compare_1 = tslib_1.__importDefault(require("../utils/Compare"));
var IPropertyPane_1 = require("./IPropertyPane");
...
var PropertyPaneConsts_1 = require("./PropertyPaneConsts");
var PropertyPaneTabList_1 = require("../propertyPaneTablist/PropertyPaneTabList");
/**
 * Page direction.
 */
var PageDirection;
...
var PropertyPane = /** @class */ (function (_super) {
    ...
    PropertyPane.prototype.componentDidMount = function () {
        ...
        domNode.style.zIndex = PropertyPaneConsts_1.zIndex.toString();
    ...
    PropertyPane.prototype.render = function () {
        ...
        var isDeThemeFlightEnabled = (0, Flights_1.isDeThemeEnabled)();
        ...
        var fabricWrapper = (React.createElement(office_ui_fabric_react_bundle_1.Fabric, { "data-sp-feature-tag": 'Property Pane', "data-sp-feature-instance-id": '_Property Pane' },
            ...
            React.createElement(office_ui_fabric_react_bundle_1.FocusTrapZone, { "data-tabster": !(0, KillSwitches_1.isPropertyPaneTabsterEnabledKSActivated)() ? '' : undefined, isClickableOutsideFocusTrap: true, forceFocusInsideTrap: false, disabled: this.props.data.configuration.disableFocusTrap },
                React.createElement("div", { className: (0, react_components_1.mergeClasses)(this.props.propertyPaneWidthMode === IPropertyPane_1.PropertyPaneWidthMode.Narrow
                        ? PropertyPane_module_scss_1.default.propertyPaneNarrow
                        : ((0, Flights_1.isODSPChatPaneResizeEnabled)() &&
                            this.props.propertyPaneWidthMode === IPropertyPane_1.PropertyPaneWidthMode.Wide) ||
                            this._isPropertyPaneExpanded
                            ? PropertyPane_module_scss_1.default.propertyPaneExpanded
                            : PropertyPane_module_scss_1.default.propertyPane, isDeThemeFlightEnabled && 'deThemePageDetails'), role: 'region', "aria-label": sp_core_library_1.Text.format(Strings_resx_1.default.UpdatedPropertyPaneAriaLabel, this.props.data.title), "aria-describedby": this._descriptionId, ref: this._propertyPane, onKeyDown: this._onPropertyPaneKeyDown, key: this.props.data.webPartId },
                    showOverlaySpinner && (React.createElement(office_ui_fabric_react_bundle_1.Overlay, { className: this._isPropertyPaneExpanded
                            ? PropertyPane_module_scss_1.default.propertyPaneExpandedOverlay
                            : PropertyPane_module_scss_1.default.overlay },
                    ...
                    !hideTitleBar && (React.createElement(PropertyPaneTitleBar_1.PropertyPaneTitleBar, { title: this.props.data.title, onClose: this._handleCloseClick, isExpanded: this._isPropertyPaneExpanded, isCustomHeaderPresent: this._isPropertyPaneExpanded && !!this.props.data.configuration.customHeader, showBackButton: !!this.props.data.configuration.showBackButton, onBackClick: this._handleBackClick })),
                    React.createElement("div", null, this._shouldRenderEmptyPage
                        ? this._renderNoConfigurationState()
                        : this._renderPage(hideTitleBar))))));
        var fabricContent = isDeThemeFlightEnabled ? (React.createElement(fluentui_neutral_components_1.DefaultV8ThemeProvider, null, fabricWrapper)) : (fabricWrapper);
        return (React.createElement(React.Fragment, null,
            isFluentVNextThemeEnabled && (React.createElement(VNextThemeWrapper_1.VNextThemeWrapper, { theme: (0, office_ui_fabric_react_bundle_1.getTheme)() }, fabricContent)),
    ...
    PropertyPane.prototype._renderPage = function (hideTitleBar) {
        ...
        var customFooter = (0, Flights_1.isCardDesignerPlusPlusFlight2Enabled)() && this.props.data.configuration.customFooter;
        var showTabLayout = !(0, KillSwitches_1.isAddTablistToProperyPaneKSActivated)() && this.props.data.configuration.pagesType === IPropertyPane_1.PagesType.Tabs;
        return (React.createElement("div", null,
            React.createElement("div", { className: (0, office_ui_fabric_react_bundle_1.css)(classForPropertyPanePageContentBottom, this._isPropertyPaneExpanded
                    ? !(0, KillSwitches_1.isAddTopMarginForExpandedPropertyPaneKSActivated)()
                        ? PropertyPanePage_module_scss_1.default.propertyPanePageContentExpanded
                        : PropertyPanePage_module_scss_1.default.propertyPanePageContentExpandedOld
                ...
                React.createElement("div", null, this.props.children),
                showTabLayout && (React.createElement(PropertyPaneTabList_1.PropertyPaneTabList, { pages: this.props.data.configuration.pages, onChangeTab: this._onChangeTab, currentPage: this.state.currentPage - 1 })),
            ...
            !customFooter && (React.createElement(PropertyPaneFooter_1.default, { isReactive: this.props.data.isReactive || false, isSaveButtonEnabled: this.state.isSaveButtonEnabled, numberOfPages: showTabLayout ? 0 : ((_b = (_a = this.props.data.configuration) === null || _a === void 0 ? void 0 : _a.pages) === null || _b === void 0 ? void 0 : _b.length) || 0, currentPage: this.state.currentPage, onSaveClick: this._handleSaveClick, onFlipPage: this._flipPage }))));
    };
    ...
    PropertyPane.prototype._getCssBottomValueForPageContentElement = function () {
        ...
        if (this.props.data.configuration.pagesType === IPropertyPane_1.PagesType.Tabs &&
