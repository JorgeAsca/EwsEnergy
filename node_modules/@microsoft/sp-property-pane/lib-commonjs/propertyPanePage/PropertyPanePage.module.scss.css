...
:global(.deThemePageDetails) .propertyPanePageTitle {
  color: unset;
}
...
:global(.deThemePageDetails) .propertyPaneClose {
  color: unset;
}
:global(.deThemePageDetails) .propertyPaneClose:hover {
...
:global(.deThemePageDetails) .propertyPaneBack {
  color: unset;
}
:global(.deThemePageDetails) .propertyPaneBack:hover {
  background-color: var(--colorNeutralBackground2Hover);
}
