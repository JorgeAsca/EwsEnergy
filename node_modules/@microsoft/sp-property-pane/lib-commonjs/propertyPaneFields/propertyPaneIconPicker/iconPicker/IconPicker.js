...
exports.IconPicker = exports.initializeAppIcons = void 0;
...
var app_icons_98056e21_woff_1 = tslib_1.__importDefault(require("./app-icons-98056e21.woff"));
...
function initializeAppIcons() {
    var subset = {
        ...
        fontFace: {
            ...
            src: "url('".concat(app_icons_98056e21_woff_1.default, "') format('woff')")
        },
        icons: {
            SharePointLogo: '\uF27E',
    ...
    (0, office_ui_fabric_react_bundle_1.unregisterIcons)(Object.keys(subset.icons));
    (0, office_ui_fabric_react_bundle_1.registerIcons)(subset, { disableWarnings: true });
}
exports.initializeAppIcons = initializeAppIcons;
var IconPicker = /** @class */ (function (_super) {
    ...
    IconPicker._getFabricMDL2IconNames = function () {
        ...
        if ((0, Flights_1.isBrandIconRefreshFlightEnabled)()) {
            initializeAppIcons();
        }
        return Object.keys(iconSettings).filter(function (iconName) {
            ...
            return (IconPicker._excludedIcons.indexOf(iconName) === -1 &&
                ...
                (iconRecord.subset.fontFace.fontFamily.indexOf(iconFontFamily) > -1 ||
                    ((0, Flights_1.isBrandIconRefreshFlightEnabled)() &&
    ...
    IconPicker.prototype.render = function () {
        ...
        return (React.createElement(Panel_1.Panel, { className: IconPicker_module_scss_1.default.panel, elementToFocusOnDismiss: this.props.elementToFocusOnDismiss, isLightDismiss: true, isOpen: this.state.isOpen, onDismiss: this._handleCancel, type: Panel_1.PanelType.extraLarge },
            React.createElement("div", { className: (0, office_ui_fabric_react_bundle_1.css)(IconPicker_module_scss_1.default.panelHeader, IconPicker_module_scss_1.default.fluent) },
                React.createElement("h2", { className: panelTitleClassName }, IconPickerStrings_resx_1.default.PanelTitle),
    ...
    IconPicker.prototype._loadDeferredComponents = function () {
        ...
        if (!(0, KillSwitches_1.isSwitchToCommonScreenReaderAlertKSActivated)()) {
            void Promise.all([
                ...
                Promise.resolve().then(function () { return tslib_1.__importStar(require(/* webpackChunkName: 'thumbnail-picker-odsp-utilities' */ '@msinternal/odsp-utilities-bundle')); })
            ]).then(function (_a) {
