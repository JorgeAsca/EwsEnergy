...
var sp_file_handler_1 = require("@msinternal/sp-file-handler");
var sp_component_utilities_1 = require("@msinternal/sp-component-utilities");
var SpFillPickerLoader_1 = require("./SpFillPickerLoader");
...
var FilePickerWrapper = /** @class */ (function () {
    function FilePickerWrapper(options) {
        var _this = this;
        this._handleSPFilePickerHostCancel = function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a;
        ...
        this._handleSPFilePickerHostPick = function (response) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
    ...
    FilePickerWrapper.prototype._startUpload = function (file) {
        ...
        if (file instanceof File) {
            ...
            (_b = (_a = this._options).onSelectFile) === null || _b === void 0 ? void 0 : _b.call(_a, file.src, undefined, this._itemsCount, {
                ...
                insertionISOTimestamp: (0, sp_component_utilities_1.getTimestampForGettyContent)(file.contentProvider)
            });
            return;
        }
        else {
            ...
            uploadPromise = this._spFileHandlerPromise.then(function (fileHandler) {
                return fileHandler.uploadExternalFile(file.src, (0, Flights_1.isPropertyPaneODBFilePickerEnabled)() ? sp_file_handler_1.SPFileHandler.replaceSpecialCharacters(file.name) : file.name);
            });
        }
