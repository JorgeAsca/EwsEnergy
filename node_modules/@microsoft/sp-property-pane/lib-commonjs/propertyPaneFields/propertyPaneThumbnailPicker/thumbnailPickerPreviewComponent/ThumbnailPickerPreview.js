...
var ThumbnailPickerPreview = /** @class */ (function (_super) {
    ...
    function ThumbnailPickerPreview(props) {
        ...
        _this._handleChangeImageClick = function () {
            if ((0, Flights_1.isPropertyPaneODBFilePickerEnabled)()) {
        ...
        _this._filePicker = new FilePickerWrapper_1.FilePickerWrapper({
            ...
            onCloseFilePicker: (0, Flights_1.isPropertyPaneODBFilePickerEnabled)() ? _this._onFilePickerClose : undefined,
    ...
    ThumbnailPickerPreview.prototype.render = function () {
        return (React.createElement("div", { className: ThumbnailPickerPreview_module_scss_1.default.root, ref: this._thumbnailWrapperRef },
            ...
            (0, ThumbnailPickerUtils_1.getThumbnailPickerButtons)(this._handleChangeImageClick, this.props.onItemDeleted, ThumbnailPickerPreview_module_scss_1.default.changeButton, this.props.disabled, 'thumbnailImagePicker'),
            (0, Flights_1.isPropertyPaneODBFilePickerEnabled)() &&
