...
var sp_pages_content_panel_context_1 = require("@msinternal/sp-pages-content-panel-context");
...
var PropertyPaneFieldChangeListeners_1 = require("./PropertyPaneFieldChangeListeners");
/**
...
var PropertyPaneController = /** @class */ (function () {
    ...
    function PropertyPaneController() {
        ...
        this._propertyPaneChangeListeners = new PropertyPaneFieldChangeListeners_1.PropertyPaneFieldChangeListeners();
        this._constructor();
    }
    /**
    ...
    PropertyPaneController.prototype.onConsumerDelete = function (id) {
        ...
        if (!(0, KillSwitches_1.isLeverageContentPanelForTopActionUpdatesKSActivated)() &&
            (0, KillSwitches_1.isDispatchAllPropertyListenersKSActivated)()) {
    ...
    PropertyPaneController.prototype._setPropertyPaneToNarrowRender = function (narrow) {
        this._paneWidthMode = narrow ? IPropertyPane_1.PropertyPaneWidthMode.Narrow : IPropertyPane_1.PropertyPaneWidthMode.Default;
    };
    /**
     * Instantiates the PropertyPaneController object.
     *
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    context) {
        if ((0, Flights_1.isODSPChatPaneResizeEnabled)()) {
            this._paneWidthMode = (toBeConfiguredConsumer === null || toBeConfiguredConsumer === void 0 ? void 0 : toBeConfiguredConsumer._getPropertyPaneWidthMode)
                ...
                : IPropertyPane_1.PropertyPaneWidthMode.Default;
        }
        else {
            this._paneWidthMode = IPropertyPane_1.PropertyPaneWidthMode.Default;
        }
        switch (propertyPaneAction) {
             ...
             */
            case 'Refresh':
                if (!(0, KillSwitches_1.isDispatchAllPropertyListenersKSActivated)()) {
    ...
    PropertyPaneController.prototype._showPropertyPane = function () {
        ...
        if ((0, Flights_1.isFabEnabled)()) {
            ...
            var updateFabPosition = function () {
                ...
                if ((0, Flights_1.isODSPChatPaneResizeEnabled)()) {
                    ...
                    position.rightOffset = _this._paneWidthMode === IPropertyPane_1.PropertyPaneWidthMode.Narrow ? 320 : 340;
                }
                postMessage({
                    type: sp_component_utilities_1.FAB_TOGGLE_EVT,
                    position: position
                });
            };
            updateFabPosition();
        ...
        if ((0, Flights_1.isODSPChatPaneResizeEnabled)()) {
            ...
            switch (this._paneWidthMode) {
                case IPropertyPane_1.PropertyPaneWidthMode.Narrow:
                    this._propertyPaneContainer.classList.add(PropertyPaneController_module_scss_1.default.showPaneNarrow);
                    break;
                case IPropertyPane_1.PropertyPaneWidthMode.Wide:
                    this._propertyPaneContainer.classList.add(PropertyPaneController_module_scss_1.default.showPaneWide);
                    break;
                default:
            ...
            this._propertyPaneContainer.classList.add(this._paneWidthMode === IPropertyPane_1.PropertyPaneWidthMode.Narrow ? PropertyPaneController_module_scss_1.default.showPaneNarrow : PropertyPaneController_module_scss_1.default.showPane);
        }
    ...
    PropertyPaneController.prototype._removeAllPropertyPaneContainerClasses = function () {
        this._propertyPaneContainer.classList.remove(PropertyPaneController_module_scss_1.default.showPaneNarrow, PropertyPaneController_module_scss_1.default.showPaneWide, PropertyPaneController_module_scss_1.default.showPane);
    };
    /**
    ...
    PropertyPaneController.prototype._hidePropertyPane = function () {
        ...
        if ((0, Flights_1.isFabEnabled)()) {
            postMessage({ type: sp_component_utilities_1.FAB_TOGGLE_EVT, position: { isShiftedForPane: false } });
            if (this._resizeHandler && (0, Flights_1.isODSPChatPaneResizeEnabled)()) {
        ...
        if ((0, Flights_1.isODSPChatPaneResizeEnabled)()) {
            ...
            this._propertyPaneContainer.classList.remove(this._paneWidthMode === IPropertyPane_1.PropertyPaneWidthMode.Narrow ? PropertyPaneController_module_scss_1.default.showPaneNarrow : PropertyPaneController_module_scss_1.default.showPane);
        }
        if ((0, Flights_1.isCardDesignerPlusPlusFlight2Enabled)() && this._isPropertyPaneExpandedClassActive()) {
            this._propertyPaneContainer.classList.remove(PropertyPaneController_module_scss_1.default.spPropertyPaneContainerExpanded);
        }
    ...
    context) {
        ...
        if (currentConsumer) {
            var contentPanelMonitor_1 = (0, Flights_1.isConfigurationToolsEnabled)()
                ? new sp_diagnostics_1._QosMonitor((0, sp_pages_content_panel_context_1.getQOSName)('PropertyPaneController', sp_pages_content_panel_context_1.SPPagesContentPanelQOSScenarios.rendering))
                : undefined;
            currentConsumer
                ...
                contentPanelMonitor_1 === null || contentPanelMonitor_1 === void 0 ? void 0 : contentPanelMonitor_1.writeUnexpectedFailure('UnhandledError', new odsp_core_bundle_1.CustomError({
                    message: (0, odsp_core_bundle_1.markPrivacyData)(String(error.message), (0, Flights_1.isContentPanelRenderLoggingEnabled)() ? 'safe' : 'unsafe'),
                    innerError: error
                }));
                throw error;
            });
