...
export var AutoAlertableMonitorType = {
    /**
...
var AutoAlertableQosMonitor = /** @class */ (function (_super) {
    __extends(AutoAlertableQosMonitor, _super);
    /**
    ...
    AutoAlertableQosMonitor.prototype._getExtraDataWithAutoAlertableFields = function (extraData) {
        ...
        returnedExtraData.autoAlertableMonitorType = AutoAlertableMonitorType[this._autoAlertableMonitorType];
        return returnedExtraData;
    };
    return AutoAlertableQosMonitor;
}(QosMonitor));
export { AutoAlertableQosMonitor };
