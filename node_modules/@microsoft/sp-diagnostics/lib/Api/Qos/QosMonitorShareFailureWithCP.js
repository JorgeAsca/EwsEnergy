...
import { _Diagnostics } from '../../index';
import { isAppendSuffixIfBrowserIsOfflineAtLoggingTimeKsActive } from '../../common/Killswitches';
/**
...
var QosMonitorShareFailureWithCP = /** @class */ (function (_super) {
    __extends(QosMonitorShareFailureWithCP, _super);
    /**
    ...
    extraData) {
        ...
        this._logCustomerPromiseFailure((ex === null || ex === void 0 ? void 0 : ex.message) || 'DefaultErrorMessage', tagNameSuffix, QosResultType.Failure, extraData);
    };
    /**
    ...
    extraData, skipLoggingCustomerPromiseFailure) {
        ...
        if (!skipLoggingCustomerPromiseFailure) {
            this._logCustomerPromiseFailure((ex === null || ex === void 0 ? void 0 : ex.message) || 'DefaultErrorMessage', tagNameSuffix, QosResultType.ExpectedFailure, extraData);
        }
    };
    /**
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    extraData) {
        if (resultType === void 0) { resultType = QosResultType.Failure; }
        if (this._extraDataForCustomerPromise) {
            this._extraDataForCustomerPromise.forEach(function (extraHandlerInfo) {
                ...
                var errorModuleName = extraHandlerInfo.errorModuleName +
                    getAuthoringSuffix() +
                    (!isAppendSuffixIfBrowserIsOfflineAtLoggingTimeKsActive() ? getOfflineSuffix() : '');
...
export { QosMonitorShareFailureWithCP };
function getAuthoringSuffix() {
    var extraDiagnosticInfo = _Diagnostics._getExtraDiagnosticInfo();
...
function getOfflineSuffix() {
    return window.navigator.onLine ? '' : ' (offline)';
}
