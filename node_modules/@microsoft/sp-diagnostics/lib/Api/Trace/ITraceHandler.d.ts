...
export interface ITraceHandler {
    ...
    log(traceEvent: ITraceLogEvent): void;
    /** Verbose trace logging operation **/
    verbose(traceVerboseEvent: IVerboseTraceLogEvent): void;
}
/**
 * IVerboseTraceLogEvent log data interface
 * @internal
 */
export interface IVerboseTraceLogEvent {
 ...
 * @internal
 */
export interface ITraceLogEvent extends IVerboseTraceLogEvent {
