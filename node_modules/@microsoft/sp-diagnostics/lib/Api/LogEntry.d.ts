...
declare class LogEntry implements ILogEntry {
    ...
    logFeature: string;
    logType: LogType;
    logProperties: Record<string, string | undefined> | undefined;
     ...
     */
    constructor(moduleName: string, logFeature?: string, logType?: LogType, logProperties?: Record<string, string | undefined>, isIntentional?: boolean);
    /**
