...
var LogEvent_1 = tslib_1.__importDefault(require("./LogEvent"));
...
var TraceLogger = /** @class */ (function () {
    ...
    Object.defineProperty(TraceLogger, "shouldWriteToConsole", {
         ...
         * Property can be changed by remote caller.
         */
        get: function () {
    ...
    TraceLogger._addEventPrefix = function (source, eventName) {
        if (!eventName) {
            ...
            return "".concat(source.id, ".").concat(eventName);
        }
    };
    /*
    ...
    TraceLogger._writeToConsole = function (logEvent, isError, resultCode) {
        ...
        if (resultCode) {
            errorString += ". resultCode: ".concat(resultCode);
        }
     ...
     */
    TraceLogger._logManager = new LogManager_1.default();
    /**
     * Allows process verbose trace log events.
     */
    TraceLogger._verboseLogManager = new LogManager_1.default();
    TraceLogger._defaultLogger = new DefaultTraceHandler_1.default();
