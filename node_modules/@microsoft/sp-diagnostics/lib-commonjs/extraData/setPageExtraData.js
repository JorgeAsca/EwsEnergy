...
var DisplayApp_1 = require("./DisplayApp");
var WebTemplateId_1 = require("./WebTemplateId");
...
function setPageExtraData(contextInfo, extraData) {
    ...
    if (!extraData.displayApp) {
        if (sp_core_library_1._BrowserUtilities.isTeamsHosted()) {
            extraData.displayApp = DisplayApp_1.DisplayApp.Teams;
            if (contextInfo.isEduClass) {
                extraData.isEduClass = true;
            }
        }
        else {
            extraData.displayApp = DisplayApp_1.DisplayApp.Sharepoint;
        }
    }
    ...
    var siteType;
    if (webTemplate === WebTemplateId_1.WebTemplateId.TeamSite) {
        siteType = 'TeamSite';
    }
    else if (webTemplate === WebTemplateId_1.WebTemplateId.GroupSite) {
        siteType = 'GroupSite';
    }
    else if (webTemplate === WebTemplateId_1.WebTemplateId.SitePagePublishing) {
    ...
    extraData.hasCopilotLicense = !(0, Killswitches_1.isTrackCopilotLicenseKSActivated)()
