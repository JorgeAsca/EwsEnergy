...
exports.PreviewUtility = exports.EMPTY_GUIDS = exports.CACHE_BREAKPOINT_XL = exports.CACHE_BREAKPOINT_S = exports.PUBLIC_CACHE_BREAKPOINT_S = exports.MAX_PIXEL_RATIO = void 0;
 ...
 * @internal
 */
exports.CACHE_BREAKPOINT_XL = 2560;
...
var PreviewUtility = /** @class */ (function () {
    ...
    PreviewUtility.getAlternateUrl = function (resourcePath, width, height, originalWidth, originalHeight, cropMode, viewportTop, viewportLeft, viewportWidth, viewportHeight, cacheBuster, encodedLQIPImage) {
        ...
        if (alternativeUrl &&
            width !== undefined &&
            !isNaN(width) &&
            ThumbnailUrlGenerator_1.default.isFileTypeSupported(PreviewUtility.getFileExtension(resourcePath))) {
            var url = new SPResourcePath_1.SPResourcePath(alternativeUrl);
    ...
    PreviewUtility.isImage = function (ext) {
        ...
        if (!PreviewUtility._imageExtensions) {
            ...
            PreviewUtility._createLookupEntries(PreviewHelper_1.PreviewHelper.IMAGE_EXTENSIONS, PreviewUtility._imageExtensions);
        }
    ...
    PreviewUtility.isVideo = function (ext) {
        ...
        if (!PreviewUtility._videoExtensions) {
            ...
            PreviewUtility._createLookupEntries(PreviewHelper_1.PreviewHelper.VIDEO_EXTENSIONS, PreviewUtility._videoExtensions);
        }
    ...
    PreviewUtility.getClampedDevicePixelRatio = function () {
        var _a;
        var clamped = 1;
        if (sp_core_library_1._SPFlight.isEnabled(1941 /* ImageSupportDevicePixelRatio */)) {
            clamped = Math.min(Math.max((_a = window.devicePixelRatio) !== null && _a !== void 0 ? _a : 1, 1), exports.MAX_PIXEL_RATIO);
        }
    ...
    PreviewUtility.getVROOMItemUrl = function (siteId, webId, listId, uniqueId, spHostBaseUrl, domainName, spResourcePath, callerId) {
        ...
        if (spHostBaseUrl &&
            ...
            var resourcePath = new SPResourcePath_1.SPResourcePath(spResourcePath);
    ...
    PreviewUtility.getFileExtension = function (path) {
        ...
        if (extensionStart > -1) {
            ...
            if (!sp_core_library_1._SPKillSwitch.isActivated('7e4eedb4-3481-417a-8a74-5ccb886abef5'
    ...
    PreviewUtility._getWidthByMeTACache = function (width, isPublicImage) {
        ...
        if (isPublicImage && width <= exports.PUBLIC_CACHE_BREAKPOINT_S) {
            ...
            return exports.CACHE_BREAKPOINT_XL;
        }
    };
    ...
    PreviewUtility._optimizableFormats = new Map([
        ['png', ThumbnailHealingKillSwitches_1.isOptimizePngKSActivated],
        ['jpg', ThumbnailHealingKillSwitches_1.isOptimizeJpegKSActivated],
        ['jpeg', ThumbnailHealingKillSwitches_1.isOptimizeJpegKSActivated]
    ]);
...
exports.PreviewUtility = PreviewUtility;
