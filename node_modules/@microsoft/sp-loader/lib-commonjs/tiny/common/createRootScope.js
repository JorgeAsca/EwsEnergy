...
function initializeGraphHttpClient(pageContext, spHttpClient, graphContext) {
    ...
    var defaultAadConfig = {
        ...
        isPairwiseBrokerEnabled: (0, flights_1.isBizChatInAppChatFlightEnabled)() ? true : undefined,
        msGraphEndpointUrl: msGraphEndpointUrl
    };
    var oboConfig;
    ...
    var msalV3EnabledAndNotTeams = !sp_core_library_1._BrowserUtilities.isTeamsHosted();
