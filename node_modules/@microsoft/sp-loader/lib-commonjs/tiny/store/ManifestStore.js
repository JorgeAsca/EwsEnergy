    ...
    ManifestStore.prototype.addManifest = function (manifest, shouldOverwrite, shouldPin, isDebug) {
        ...
        if (shouldPin ||
            (!sp_core_library_1._SPFlight.isDebugFlightEnabled &&
                ...
                id !== componentConstants_1.reactQueryComponentId &&
                id !== componentConstants_1.tslibComponentId &&
                id !== componentConstants_1.swcHelpersComponentId)) {
    ...
    ManifestStore.prototype.clearManifests = function () {
        ...
        this._store.forEach(function (sEntry, sKey) {
            if (!sEntry.isPinned &&
                ...
                sKey !== componentConstants_1.reactQueryComponentId &&
                sKey !== componentConstants_1.tslibComponentId &&
                sKey !== componentConstants_1.swcHelpersComponentId) {
                sEntry.manifests.forEach(function (mEntry, mKey) {
                    if (!mEntry.isDebug) {
                        // If there is only one manifest delete the whole entry
                        if (sEntry.manifests.size === 1) {
        ...
        if (storeEntry) {
            ...
            if (!version) {
                ...
                if (!manifest) {
                     ...
                     */
                    if (!(0, killSwitches_1.isVivaHomeReloadKSActive)() &&
                        storeVersions_1.length &&
                        location.pathname.indexOf('/_layouts/15/vivahome.aspx') !== -1 &&
                        location.search.indexOf('sw=bypass') === -1) {
                        var versionMismatchDetectionMonitor = new sp_telemetry_1._QosMonitor('VivaHome.ManifestVersionMismatch');
                        versionMismatchDetectionMonitor.writeUnexpectedFailure('mismatch detected', error);
                        if ((0, killSwitches_1.isVivaHomeReloadWithBypassKSActive)()) {
