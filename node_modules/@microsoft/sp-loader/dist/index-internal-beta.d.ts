...
import type { IODataBasePermission } from '@microsoft/sp-odata-types';
import type { IODataContextWebInformation } from '@microsoft/sp-odata-types';
import type { IODataList } from '@microsoft/sp-odata-types';
import type { IODataListItem } from '@microsoft/sp-odata-types';
import type { IODataNavigationNodeCollection } from '@microsoft/sp-odata-types';
import type { _IODataPageContextInfo } from '@microsoft/sp-odata-types';
import type { IODataUser } from '@microsoft/sp-odata-types';
import type { IODataWeb } from '@microsoft/sp-odata-types';
import { ServiceScope } from '@microsoft/sp-core-library';

/* Excluded from this release type: _APP_WORKLOAD_QSP */
...
/* Excluded from this release type: _IExtendedPreloadedData */
...
/* Excluded from this release type: _INCLUDE_APP_WORKLOAD */
...
/* Excluded from this release type: _OldManifestStoreShim */
...
export declare class SPComponentLoader {
    ...
    /* Excluded from this release type: refreshWebPartManifests */
