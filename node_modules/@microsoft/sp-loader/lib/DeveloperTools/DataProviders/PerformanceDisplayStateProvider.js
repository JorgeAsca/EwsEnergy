...
import { _Telemetry } from '@msinternal/sp-telemetry';
...
var PerformanceDisplayStateProvider = /** @class */ (function () {
    ...
    PerformanceDisplayStateProvider.getState = function () {
        ...
        var toReturn = {
            ...
            speedOfLight: 0,
            timeToInteractive: 0,
            clientBuildVersion: _Telemetry.buildNumber
        };
        ...
        try {
            ...
            if (data.headStart && data.headEnd && data.bodyStart) {
                ...
                perfItems.push({
                    ...
                    name: strings.ServerResponseWaitLabel,
                ...
                perfItems.push({
                    id: 'body',
                    name: strings.BodyExecutionLabel,
