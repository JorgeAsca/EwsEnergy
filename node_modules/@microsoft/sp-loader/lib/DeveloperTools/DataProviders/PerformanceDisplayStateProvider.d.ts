import type { IPerformanceDisplayState } from '../Components/DeveloperModules/PerformanceDisplay/PerformanceDisplay';
export declare class PerformanceDisplayStateProvider {
    /**
     ...
     */
    static getState(): IPerformanceDisplayState;
    /**
     * Splits the WebPart id to access the alias.
     */
    private static _getReadableWebpartName;
}
