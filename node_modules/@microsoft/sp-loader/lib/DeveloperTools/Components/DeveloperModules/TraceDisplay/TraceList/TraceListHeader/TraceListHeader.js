...
var TraceListHeader = /** @class */ (function (_super) {
    ...
    TraceListHeader.prototype.render = function () {
        ...
        return (React.createElement("ul", { className: styles.container },
            ...
            React.createElement("li", { className: styles.level },
                React.createElement("p", { role: 'button', onClick: this._handleLevelClick, className: styles.headerText }, strings.LevelHeaderLabel),
                React.createElement("button", { onClick: this._handleLevelClick, className: [styles.filterButton, getIconClassName('Filter')].join(' ') }),
                React.createElement("div", { className: this._getFilterStyleForColumn('level'), id: 'levelFilterDropdown' }, Object.keys(this.props.filters.level).map(function (id) { return (React.createElement("div", { key: id, className: styles.filterRow },
            ...
            React.createElement("li", { className: styles.scope },
                React.createElement("p", { role: 'button', onClick: this._handleScopeClick, className: styles.headerText }, strings.ScopeHeaderLabel),
                React.createElement("button", { onClick: this._handleScopeClick, className: [styles.filterButton, getIconClassName('Filter')].join(' ') }),
                React.createElement("div", { className: this._getFilterStyleForColumn('scope'), id: 'scopeFilterDropdown' }, Object.keys(this.props.filters.scope).map(function (id) { return (React.createElement("div", { key: id, className: styles.filterRow },
            ...
            React.createElement("li", { className: styles.source },
                React.createElement("p", { role: 'button', onClick: this._handleSourceClick, className: styles.headerText }, strings.SourceHeaderLabel),
                React.createElement("button", { onClick: this._handleSourceClick, className: [styles.filterButton, getIconClassName('Filter')].join(' ') }),
                React.createElement("div", { className: this._getFilterStyleForColumn('source'), id: 'sourceFilterDropdown' }, Object.keys(this.props.filters.source).map(function (id) { return (React.createElement("div", { key: id, className: styles.filterRow },
    ...
    TraceListHeader.prototype._getFilterStyleForColumn = function (columnId) {
        var filterStyle = this.state.filterToggles[columnId] ? styles.displayBlock : styles.displayNone;
