...
import { DetailsList, SelectionMode, Selection, ConstrainMode } from '@fluentui/react/lib/DetailsList';
...
var ManifestManager = /** @class */ (function (_super) {
    ...
    ManifestManager.prototype.render = function () {
        ...
        var manifestDetailsBox = selectedManifest ? (React.createElement(ManifestDetails, { manifest: selectedManifest })) : (React.createElement("div", { className: styles.noManifestSelectedContainer },
