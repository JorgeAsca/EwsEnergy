...
import type { ISPComponentLoader } from '../interfaces/ISPComponentLoader';
...
export declare class SPComponentLoader {
     ...
     * @internal
     */
    static _preloadComponents(): void;
    /**
     ...
     * @alpha
     */
    static refreshWebPartManifests(manifests: IClientSideComponentManifest[]): void;
    /**
     * {@inheritDoc  _ISPComponentLoader._manifestReferences}
     *
     * @internal
     */
    ...
    /**
     * {@inheritdoc _ISPComponentLoader.requestManifest}
     *
     * @alpha
     */
     ...
     * @internal
     */
    static _loadDebugManifestsForWorkbench(manifestsFileUrl: string): Promise<IClientSideComponentManifest[]>;
}
