...
import { startApplication } from '../tiny/common/platformLoader';
/**
...
var BaseComponentLoader = /** @class */ (function () {
    ...
    BaseComponentLoader.prototype._startApplication = function (preloadedData) {
        ...
        return startApplication(preloadedData, this._serviceScope).then(function (application) {
