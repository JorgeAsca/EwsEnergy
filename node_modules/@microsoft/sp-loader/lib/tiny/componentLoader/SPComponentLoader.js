...
import { reactComponentId, reactDomComponentId, reactQueryComponentId, swcHelpersComponentId, tslibComponentId } from '../../utilities/componentConstants';
import { isLogSPFxVersionFor3pComponentsKSActivated } from '../../utilities/KillSwitches';
...
var SPComponentLoader = /** @class */ (function () {
    ...
    SPComponentLoader.prototype.loadComponent = function (manifest) {
        ...
        if (!manifest.isInternal) {
            ...
            if (!isLogSPFxVersionFor3pComponentsKSActivated()) {
    ...
    SPComponentLoader.prototype._loadDebugManifestsForWorkbench = function (manifestsFileUrl) {
        ...
        return DebugManager.ensureDebugHandlersAsync().then(function (_a) {
            var loadAndRegisterManifestsFileAsync = _a.loadAndRegisterManifestsFileAsync;
            return loadAndRegisterManifestsFileAsync(_this, manifestsFileUrl, /* registerAsNonDebug */ true);
        });
    };
    /**
    ...
    SPComponentLoader.prototype.refreshWebPartManifests = function (manifests) {
        ManifestStore.instance.refreshWebPartManifests(manifests);
    };
