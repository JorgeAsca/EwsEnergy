...
import strings from '../../stores/Stores.resx';
/**
...
var ComponentStore = /** @class */ (function () {
    ...
    ComponentStore.prototype.tryGetComponent = function (id, version) {
        return this._componentPromises.get(normalizeComponentId(id, version));
    };
    /**
    ...
    ComponentStore.prototype.tryGetComponentReference = function (id, version) {
        return this._components.get(normalizeComponentId(id, version));
    };
    /**
    ...
    ComponentStore.prototype.getComponentById = function (id) {
        ...
        if (versions.length !== 1) {
            var msg = versions.length === 0 ? strings.noComponentFoundError : strings.tooManyComponentsError;
            throw new Error(Text.format(msg, id));
        }
        // If a version exists then the component must exist in either map
        var normalizedId = normalizeComponentId(id, versions[0]);
        var retVal;
