...
import type { _IODataPageContextInfo, IODataWeb, IODataUser, IODataList, IODataListItem, IODataContextWebInformation, IODataNavigationNodeCollection, IODataBasePermission } from '@microsoft/sp-odata-types';
/**
...
/**
 * The minimal set of preloaded data needed to start the bootstrap of an SPFX environment.
 *
 * @internal
 */
export interface IMinimalPreloadedData {
    /**
    ...
    /**
     * {@inheritdoc @microsoft/sp-odata-types#IODataListItem.UniqueId}
     */
    listItemId?: string;
    /**
     * A flag indicating whether this preloaded data is from a first flush.
     */
...
export interface IPreloadedData {
    ...
    modifiedDate?: string;
    /**
     * list of application global API endpoints approved for use in the tenant
     */
    ApplicationAPIEndpoints?: string;
    /**
     * If this page load is from a server transfer, this is the URL of the page that the server responded with.
     */
    serverTransferUrl?: string;
    /**
     * If this app is a foundation app
     */
    isFoundation?: boolean;
}
/**
 * Extended preloaded data including performance information.
 * @internal
 */
export interface IExtendedPreloadedData {
    perf?: {
        ...
        CPUDuration: number;
        ClaimsAuthenticationTime: number;
    };
    firstFlushPerf?: {
        spRequestDuration: number;
        QueryCount: number;
