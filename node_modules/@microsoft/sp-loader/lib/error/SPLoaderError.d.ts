...
export declare enum SPLoaderErrorCode {
    ...
    urlStatusDocLibNetworkErrorError = 18,
    urlStatusHttpsNetworkErrorError = 19,
    urlStatusNetworkErrorError = 20,
    urlStatusUndefinedError = 21,
    failedToCreateGlobalVariable = 22,
    dependencyLoadError = 23,
    missingPathDependencyError = 24
}
/**
 * sp-loader errors.
 *
...
export default class SPLoaderError extends SPError {
    ...
    private _isExpected;
    constructor(errorCode: SPLoaderErrorCode, innerError: Error | undefined, isExpected: boolean, ...params: unknown[]);
    /**
     * Error id.
     */
    get id(): number;
...
//# sourceMappingURL=SPLoaderError.d.ts.map