...
var SPLoaderError = /** @class */ (function (_super) {
    ...
    function SPLoaderError(errorCode, innerError, isExpected) {
        ...
        var _this = _super.call(this, SPLoaderErrorCode[errorCode], Text.format.apply(Text, __spreadArray([SPLoaderError._errorCodeToMessageMap.get(errorCode)], params, false))) || this;
