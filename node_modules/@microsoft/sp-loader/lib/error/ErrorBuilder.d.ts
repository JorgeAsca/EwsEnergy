import type { IClientSideComponentManifest, IComponentModuleConfiguration, IIntegrityPath } from '@microsoft/sp-module-interfaces';
...
export default class ErrorBuilder {
    ...
    static buildLoadComponentDependencyFailoverPathError(manifest: IClientSideComponentManifest, dependencyName: string, failoverPath: string | IIntegrityPath, error: Error): SPLoaderError;
    ...
    private static _buildErrorWithVerboseLog;
    private static _buildErrorWithErrorLog;
}
