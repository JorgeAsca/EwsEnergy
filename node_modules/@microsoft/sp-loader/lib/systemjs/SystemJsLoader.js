...
import strings from './SystemsJs.resx';
/**
 * Loader for SystemJS.
...
var SystemJsLoader = /** @class */ (function () {
    ...
    SystemJsLoader.prototype.load = function (manifest, name, globalName) {
        var _this = this;
        return this.systemImport(normalizeName(manifest, name)).then(function (module) {
            var retValue = module;
    ...
    SystemJsLoader.prototype.systemImport = function (name) {
        try {
            ...
            _TraceLogger.logError(telemetryConstants.loadComponentLogSource, error, SystemJsLoader._systemImportEventName);
            ...
            if (resources[name_1].type === 'component') {
                ...
                if (moduleConfiguration.failoverPath) {
                    if (this._configuredFailoverPaths.indexOf(name_1) === -1) {
                        ...
                        void loadScriptWithoutEval(address, false /* Do not append .js to url */);
                        AddressStore.set(normalizedName, address);
    ...
    SystemJsLoader.prototype._setCustomLoader = function (pluginName, system) {
        var loader = {
            ...
            locate: function (module) {
                var address = AddressStore.tryGetAddress(module.name);
                if (address) {
                    // TODO (1213908): Handle the subresource integrity
                    return address.path;
                }
                else {
                    _TraceLogger.logVerbose(telemetryConstants.loadComponentLogSource, "Address not found for module name: ".concat(module.name, ". Using it as absolute URL."));
