...
var LOG_SOURCE = _LogSource.create('ResourceUrlChecker');
...
var ResourceUrlChecker = /** @class */ (function () {
    ...
    ResourceUrlChecker.checkResourceUrl = function (manifest, name) {
        ...
        var url = resolveAddress(manifest, name, ResourceUrlChecker.useSecondaryCdn);
    ...
    ResourceUrlChecker._getUrlStatus = function (url) {
        ...
        return window
            ...
            _TraceLogger.logError(LOG_SOURCE, error);
