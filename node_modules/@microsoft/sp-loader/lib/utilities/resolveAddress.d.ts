import type { IClientSideComponentManifest, IIntegrityPath } from '@microsoft/sp-module-interfaces';
/**
 ...
 */
export default function resolveAddress(manifest: IClientSideComponentManifest, resourceName: string, useSecondaryCdn?: boolean): IIntegrityPath;
