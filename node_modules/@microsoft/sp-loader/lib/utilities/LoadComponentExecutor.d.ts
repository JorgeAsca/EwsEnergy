...
export default class LoadComponentExecutor {
    ...
    constructor(loadFunction: (manifest: IClientSideComponentManifest, retryCount?: number) => Promise<unknown>);
    setAlternativeExecutor(executor: LoadComponentExecutor): void;
    loadComponent<T>(manifest: IClientSideComponentManifest, retryCount?: number): Promise<T>;
    /**
