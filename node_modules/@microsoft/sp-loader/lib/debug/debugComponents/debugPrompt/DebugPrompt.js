...
var DebugPrompt = /** @class */ (function (_super) {
    ...
    DebugPrompt.prototype.render = function () {
        ...
        return !this.state.dismissed ? (React.createElement("div", { role: 'dialog', "data-automation-id": 'debugManifestPromptDialog', "aria-labelledby": 'manifestWarningLabel' },
            ...
            !!this.state.showCallout && (React.createElement(Callout, { className: css(styles.callout, (_a = {}, _a[styles.calloutFadeIn] = !!this.state.showCallout, _a)), target: this._calloutRef, directionalHint: DirectionalHint.bottomCenter, gapSpace: 10 },
                React.createElement("div", { className: styles.calloutText }, strings.debugManifestLoadingCalloutText))))) : (React.createElement(React.Fragment, null, " "));
    };
    return DebugPrompt;
}(React.Component));
