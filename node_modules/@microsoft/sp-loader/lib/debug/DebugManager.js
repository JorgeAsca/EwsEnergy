...
var DebugManager = /** @class */ (function () {
    ...
    DebugManager.ensureDebugHandlersAsync = function () {
        if (!DebugManager._debugHandlers) {
            DebugManager._debugHandlers = import(
 ...
 */
export function getSPFxDebugSessionData() {
    var spfxDebugSessionData = {};
    try {
        spfxDebugSessionData = JSON.parse(sessionStorage.getItem(SPFX_DEBUG_SESSION_VAR_ID) || '{}');
    }
    catch (e) {
