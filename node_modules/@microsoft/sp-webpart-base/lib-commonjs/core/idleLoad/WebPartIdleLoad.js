...
exports.WebPartIdleLoad = void 0;
var tslib_1 = require("tslib");
var sp_loader_1 = require("@microsoft/sp-loader");
var sp_core_library_1 = require("@microsoft/sp-core-library");
var IdleLoadComponentFactory_1 = require("./IdleLoadComponentFactory");
...
function getManifest(webPartData) {
    ...
    return sp_loader_1.SPComponentLoader.tryGetManifestById(webPartData.id);
}
...
function isIdleLoadComponentForDisplayMode(component, displayMode) {
    ...
    switch (displayMode) {
        case sp_core_library_1.DisplayMode.Edit:
            return idleDisplayMode === 'edit';
        case sp_core_library_1.DisplayMode.Read:
...
var WebPartIdleLoad = /** @class */ (function () {
    ...
    WebPartIdleLoad.prototype.cancelPrefetching = function (instanceId) {
        ...
        (_a = getIdleLoadComponentIdsFromWebPartData(webPartData)) === null || _a === void 0 ? void 0 : _a.forEach(function (componentId) {
            IdleLoadComponentFactory_1.IdleLoadComponentFactory.instance.removeComponent(instanceId, componentId);
        });
        this._prefetchWebParts.delete(instanceId);
    };
    WebPartIdleLoad.prototype.cancelAllPrefetching = function () {
        IdleLoadComponentFactory_1.IdleLoadComponentFactory.instance.reset();
    ...
    WebPartIdleLoad.prototype.prefetchWebPart = function (control, displayMode, manifest) {
        ...
        for (var _i = 0, idleLoadComponents_1 = idleLoadComponents; _i < idleLoadComponents_1.length; _i++) {
            ...
            if (isIdleLoadComponentForDisplayMode(component, displayMode)) {
                idleLoadComponentsWithRequestorId.set(component.componentId, tslib_1.__assign(tslib_1.__assign({}, component), { requestorIds: [control.instanceId] // add the requestor ID to the component
                 }));
            }
        }
        return IdleLoadComponentFactory_1.IdleLoadComponentFactory.instance.fetchIdleLoadComponents(Array.from(idleLoadComponentsWithRequestorId.values()));
    };
    /**
        ...
        var _loop_1 = function (webPartData) {
            ...
            idleLoadComponentsForDisplayMode === null || idleLoadComponentsForDisplayMode === void 0 ? void 0 : idleLoadComponentsForDisplayMode.forEach(function (idleLoadComponent) {
                ...
                if (existingComponent) {
                    ...
                    idleLoadComponentsWithRequestorId.set(idleLoadComponent.componentId, tslib_1.__assign(tslib_1.__assign({}, idleLoadComponent), { requestorIds: [webPartData.instanceId] }));
                }
            });
...
exports.WebPartIdleLoad = WebPartIdleLoad;
