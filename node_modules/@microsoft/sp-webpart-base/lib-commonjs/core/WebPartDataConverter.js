...
exports.WebPartDataConverter = void 0;
...
var WebPartDataConverter = /** @class */ (function () {
    ...
    WebPartDataConverter.convertHtmlToWebPartData = function (htmlString, links) {
        ...
        if (wpHtmlDiv && wpHtmlDiv.hasAttribute(WebPartDataConverter._webPartAttribute)) {
            ...
            if (wpdata) {
                var htmlPropsDiv = wpHtmlDiv.querySelector("[".concat(WebPartDataConverter._htmlPropertiesAttribute, "]"));
    ...
    WebPartDataConverter.convertServerProcessedDataToHtml = function (serverContent) {
        ...
        if (serverContent) {
            if (serverContent.htmlStrings) {
                result += WebPartDataConverter._convertServerProcessedDataToHtmlByType(serverContent.htmlStrings, sp_component_base_1._ServerProcessedDataType.htmlString);
            }
            if (serverContent.searchablePlainTexts) {
                result += WebPartDataConverter._convertServerProcessedDataToHtmlByType(serverContent.searchablePlainTexts, sp_component_base_1._ServerProcessedDataType.searchablePlainText);
            }
            if (serverContent.links) {
                result += WebPartDataConverter._convertServerProcessedDataToHtmlByType(serverContent.links, sp_component_base_1._ServerProcessedDataType.link);
            }
            if (serverContent.imageSources) {
                result += WebPartDataConverter._convertServerProcessedDataToHtmlByType(serverContent.imageSources, sp_component_base_1._ServerProcessedDataType.imageSource);
            }
        }
        return result;
    };
    ...
    WebPartDataConverter._convertServerProcessedDataToHtmlByType = function (properties, type) {
        ...
        for (var _i = 0, _a = Object.entries(properties); _i < _a.length; _i++) {
            var _b = _a[_i], propPath = _b[0], value = _b[1];
    ...
    WebPartDataConverter._getHtmlString = function (propName, propType, propValue) {
        ...
        if (propName && typeof propValue === 'string' && propValue) {
            switch (propType) {
                case sp_component_base_1._ServerProcessedDataType.htmlString:
                    ...
                    break;
                case sp_component_base_1._ServerProcessedDataType.searchablePlainText:
                    ...
                    break;
                case sp_component_base_1._ServerProcessedDataType.link:
                    ...
                    break;
                case sp_component_base_1._ServerProcessedDataType.imageSource:
    ...
    WebPartDataConverter._normalizeHTML = function (htmlString) {
        ...
        tempDiv.innerHTML = "<div class='child1'></div><div class='main'>".concat(htmlString, "</div><div class='child3'></div>");
