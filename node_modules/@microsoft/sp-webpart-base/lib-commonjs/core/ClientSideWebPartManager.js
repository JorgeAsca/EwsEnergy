...
var ClientSideWebPartManager = /** @class */ (function () {
            ...
            return syncTeamsComponentPromise.then(function () {
                ...
                return _this._doesUserHasPermissions(context_3.manifest).then(function (hasPermissions) {
                    ...
                    if (isACE_2) {
                        ...
                        if (!(0, KillSwitches_1.isFixAceWebPartTagMismatchKSActivated)()) {
                    ...
                    if ((0, KillSwitches_1.isFixAceWebPartTagMismatchKSActivated)() || !isACE_2 || !context_3.webPartTag) {
                        context_3.webPartTag = ClientSideWebPartManager.createWebPartTag(context_3.manifest, context_3.instanceId);
                    }
                    ...
                    return (new Promise(function (resolve) {
                        ...
                        if ((0, Flights_1.isLoadEditModeWebPartsInParallelEnabled)() && webPartData) {
    ...
    ClientSideWebPartManager.prototype._swapManifestForWebparts = function (context) {
        ...
        var monitor;
        if (!(0, KillSwitches_1.isAddLoggingForSwapManifestsKSActivated)()) {
            monitor = new sp_diagnostics_1._QosMonitor('ClientSideWebPartManager.SwapManifests');
        }
        if (context.manifest.id === IMAGE_WEBPART_V1_MANIFEST_ID &&
            ...
            if (manifestCandidate) {
                if (!(0, KillSwitches_1.isAddLoggingForSwapManifestsKSActivated)() && monitor) {
                    monitor.writeSuccess();
                }
                context.manifest = manifestCandidate;
            }
            else if (!(0, KillSwitches_1.isAddLoggingForSwapManifestsKSActivated)() && monitor) {
    ...
    ClientSideWebPartManager.prototype._loadWebPartPrefetching = function () {
        ...
        this.webPartPrefetching || (this.webPartPrefetching = new WebPartIdleLoad_1.WebPartIdleLoad());
