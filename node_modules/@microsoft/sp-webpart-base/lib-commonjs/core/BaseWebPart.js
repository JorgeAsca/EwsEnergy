...
var BaseWebPart = /** @class */ (function (_super) {
    ...
    BaseWebPart.prototype._addAudienceTargetingConfiguration = function (configuration) {
        ...
        if (audienceFormService && audienceFormService.renderAudienceFormPropertyPaneField) {
            ...
            if (!(0, KillSwitches_1.isAudienceTargetingForMultiColumnPropertyPaneKSActive)()) {
                ...
                var columnIndex = !(0, KillSwitches_1.isFixUnwantedAudienceTargetingForExpandedPropertyPaneKSActivated)()
    ...
    BaseWebPart.prototype._addVisibilityConfiguration = function (configuration) {
        ...
        var showInMobileAndEmailToggle = {
            type: SPPropertyPane_1.PropertyPaneFieldType.Toggle,
            targetProperty: HIDE_ON_MOBILE_PROPERTY,
            properties: tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ label: Strings_resx_1.default.ShowInMobileAndEmailToggleLabel }, ((0, KillSwitches_1.isWebPartHideOnMobileScreenReaderFixKSActivated)() && {
                offAriaLabel: Strings_resx_1.default.ShowInMobileAndEmailToggleOffAriaLabel
            })), { offText: Strings_resx_1.default.ShowInMobileAndEmailToggleOffText }), ((0, KillSwitches_1.isWebPartHideOnMobileScreenReaderFixKSActivated)() && {
                onAriaLabel: Strings_resx_1.default.ShowInMobileAndEmailToggleOnAriaLabel
            })), { onText: Strings_resx_1.default.ShowInMobileAndEmailToggleOnText, dataAutomationId: 'controlShowInMobileAndEmailToggle', checked: !this._hideOn.mobile })
        };
        var visibilityGroup = {
            groupName: Strings_resx_1.default.VisibilityGroupName,
