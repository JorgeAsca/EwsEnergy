...
exports.isFixAceWebPartTagMismatchKSActivated = exports.isRefactorReInstateServerProcessedDataKSActive = exports.isAddLoggingForSwapManifestsKSActivated = exports.isDisableHideOnMobileInAmplifyKSActivated = exports.isWebPartHideOnMobileScreenReaderFixKSActivated = exports.isWebPartHideOnMobileKSActivated = exports.isFetchEditModeWebPartsInParallelKSActivated = exports.isClickToAddFromContentPaneKSActivated = exports.isTranspileAlreadyLoadedWPKSActivated = exports.isFixUnstableThumbnailKSActivated = exports.isHandleDisposeRaceConditionKSActive = exports.isRefactorLoadWebPartKSActivated = exports.isFixUnwantedAudienceTargetingForExpandedPropertyPaneKSActivated = exports.updateMissingWebPartLifeCycleVetoesKSActivated = exports.isAudienceTargetingForMultiColumnPropertyPaneKSActive = exports.isShowErrorAceForBlockedAceKSActivated = exports.isOverrideDataPersistedFlagKSActive = exports.isUsePromiseAllForFetchWebPartsKSActivated = exports.isAsyncCompleteKSActivated = exports.isWebPartManifestListCacheRefreshKSActivated = exports.isAccessibleRootKSActivated = exports.isDashboardWebPartMediumCardBreakPointKSActivated = exports.isAddMoreRenderErrorInfoKSActivated = exports.isDashboardWebPartVerticalLayoutCardWidthFix = exports.isExemptWebPartWithDynamicDataFromLazyLoadKSActivated = exports.isAlwaysShowIsolatedACEOnTeamsKSActive = exports.isVivaHomeIsolatedAceCheckKSActive = exports.isPropertyPaneUpdateASHAVetoKSActivated = exports.isIsolatedACEWPRenderAsyncKSActivated = exports.isPreventLateIframeRedirectKSActivated = exports.isUberIsolatedACEFlightKSActivated = exports.isSafariIsolationKSActivated = exports.isLogWebPartLoadErrorKSActivated = exports.isFixMissingContextKSActivated = exports.isDynamicIframedPropertyPaneHandlingKSActivated = exports.isIsolatedAdaptiveCardExtensionIframedPropertyPaneKSActivated = exports.isChainDisposeCallsAfterOninitKSActivated = exports.isIsolatedAdaptiveCardExtensionWebPropertyPaneWorkAroundKSActivated = exports.isConfigurationToolsKSActivated = exports.isIsolatedWebPartTabStopKSActivated = void 0;
...
function isAudienceTargetingForMultiColumnPropertyPaneKSActive() {
    return sp_core_library_1._SPKillSwitch.isActivated('4f5fdd22-e54b-443e-b79a-6134a5e59e8d'
    /* '03/19/2024', 'Add configuration option for audience targeting in multi column property pane' */
    );
}
exports.isAudienceTargetingForMultiColumnPropertyPaneKSActive = isAudienceTargetingForMultiColumnPropertyPaneKSActive;
function updateMissingWebPartLifeCycleVetoesKSActivated() {
    return sp_core_library_1._SPKillSwitch.isActivated('4a64c8cf-892b-4f83-8fe4-3a2245297f76'
    /* '03/21/2024', 'atagle - update missing web part lifecycle vetoes' */
    );
}
exports.updateMissingWebPartLifeCycleVetoesKSActivated = updateMissingWebPartLifeCycleVetoesKSActivated;
function isFixUnwantedAudienceTargetingForExpandedPropertyPaneKSActivated() {
    return sp_core_library_1._SPKillSwitch.isActivated('6d1353bf-844b-4683-afdd-07d4dae51ea2'
    /* '05/17/2024', 'Ensure only add audience targeting field if explicitly configured for expanded property pane' */
    );
}
exports.isFixUnwantedAudienceTargetingForExpandedPropertyPaneKSActivated = isFixUnwantedAudienceTargetingForExpandedPropertyPaneKSActivated;
function isRefactorLoadWebPartKSActivated() {
    return sp_core_library_1._SPKillSwitch.isActivated('e11d11a3-f2a0-4cc3-8c36-60f157abdb47'
    /* '08/01/2024', 'Refactor load webpart to separate render' */
    );
}
exports.isRefactorLoadWebPartKSActivated = isRefactorLoadWebPartKSActivated;
function isHandleDisposeRaceConditionKSActive() {
    return sp_core_library_1._SPKillSwitch.isActivated('a1b3f56e-4ebf-4ae2-bb75-146286e336e4'
    /* '10/21/2024', 'liaye - Handle race condition that caused by disposed web parts' */
    );
}
exports.isHandleDisposeRaceConditionKSActive = isHandleDisposeRaceConditionKSActive;
function isFixUnstableThumbnailKSActivated() {
    return sp_core_library_1._SPKillSwitch.isActivated('e34f2e15-eaed-404b-93ee-bed24f7e5eec' /* '10/17/2024', 'tialu: fix unstable thumbnail' */);
}
exports.isFixUnstableThumbnailKSActivated = isFixUnstableThumbnailKSActivated;
function isTranspileAlreadyLoadedWPKSActivated() {
    return sp_core_library_1._SPKillSwitch.isActivated('b56be5bc-975c-4c10-b387-808c5404f3b3'
    /* '11/04/2024', 'poorvitusam - Use loaded webpart for transpile' */
    );
}
exports.isTranspileAlreadyLoadedWPKSActivated = isTranspileAlreadyLoadedWPKSActivated;
function isClickToAddFromContentPaneKSActivated() {
    return sp_core_library_1._SPKillSwitch.isActivated('757e6220-8354-49d2-979a-cd70080da6d9' /* '10/29/2024', 'jayharrs click to add from content panel to existing web parts' */);
}
exports.isClickToAddFromContentPaneKSActivated = isClickToAddFromContentPaneKSActivated;
// cross-project kill switch
function isFetchEditModeWebPartsInParallelKSActivated() {
    return sp_core_library_1._SPKillSwitch.isActivated('aed8b9b5-945b-40f3-92db-90d949177b79'
    /* '04/09/2025', 'jayharris: fetches edit mode web part resources in parallel when loading canvas edit modules' */
    );
}
exports.isFetchEditModeWebPartsInParallelKSActivated = isFetchEditModeWebPartsInParallelKSActivated;
// cross-project ks
function isWebPartHideOnMobileKSActivated() {
    return sp_core_library_1._SPKillSwitch.isActivated('388b763f-ab2b-4370-8a72-6bf6c3fd27e7'
    /* '06/17/2025', 'joyoshioka - Add ability to toggle controls' visibility in mobile and transpile.' */
    );
}
exports.isWebPartHideOnMobileKSActivated = isWebPartHideOnMobileKSActivated;
// cross-project ks
...
// cross-project ks
function isDisableHideOnMobileInAmplifyKSActivated() {
    return sp_core_library_1._SPKillSwitch.isActivated('b91e1b33-c72e-47de-b403-e0a38a2e2908'
    /* '07/22/2025', 'joyoshioka - Disable hide on mobile in Amplify.' */
    );
}
exports.isDisableHideOnMobileInAmplifyKSActivated = isDisableHideOnMobileInAmplifyKSActivated;
function isAddLoggingForSwapManifestsKSActivated() {
    return sp_core_library_1._SPKillSwitch.isActivated('a03bbc6d-2c7c-4a64-bc5e-13e270dba8b2'
    /* '08/08/2025', 'laurabeall - Add qos monitor for swapWebPartManifests' */
    );
}
exports.isAddLoggingForSwapManifestsKSActivated = isAddLoggingForSwapManifestsKSActivated;
function isRefactorReInstateServerProcessedDataKSActive() {
    return sp_core_library_1._SPKillSwitch.isActivated('65bd9864-ee8b-4af8-94ba-bb6240785747'
    /* '08/19/2025', 'liaye - Refactor re-instate server processed data' */
    );
}
exports.isRefactorReInstateServerProcessedDataKSActive = isRefactorReInstateServerProcessedDataKSActive;
function isFixAceWebPartTagMismatchKSActivated() {
    return sp_core_library_1._SPKillSwitch.isActivated('3c868adc-489d-4a51-8881-19166ed91492'
    /* '9/23/2025', 'Fix ACE webpart tag override to prevent A11y bugs by preserving original tag' */
    );
}
exports.isFixAceWebPartTagMismatchKSActivated = isFixAceWebPartTagMismatchKSActivated;
