 ...
 * @remarks We have left the original implementation here to avoid breaking the public API contract.
 */
export declare const _PropertyPaneAction: {
    /**
...
/**
 * {@inheritdoc (_PropertyPaneAction:variable)}
 * @internal
 */
export type _PropertyPaneAction = (typeof _PropertyPaneAction)[keyof typeof _PropertyPaneAction];
/**
