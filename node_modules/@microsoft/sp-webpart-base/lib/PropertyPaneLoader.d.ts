 ...
 * @internal
 */
export default class PropertyPaneLoader {
    /**
     * Service key to uniquely identify PropertyPaneLoader in the service scope.
     */
    static readonly serviceKey: ServiceKey<PropertyPaneLoader>;
     ...
     */
    get propertyPane(): Promise<_IConfigurableOptionsController>;
    /**
     ...
     */
    get isLoaded(): boolean | undefined;
}
//# sourceMappingURL=PropertyPaneLoader.d.ts.map