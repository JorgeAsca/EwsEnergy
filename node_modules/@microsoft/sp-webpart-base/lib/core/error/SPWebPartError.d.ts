...
export declare enum SPWebPartErrorCode {
    ...
    RenderPromiseUndefined = 22,
    RenderTimeout = 23,
    TranspileNotImplemented = 24
}
/**
 * Web part errors.
 *
...
export declare class SPWebPartError extends SPError {
     ...
     */
    get category(): string;
    static create(errorCode: SPWebPartErrorCode | string | undefined, ...params: any[]): SPWebPartError;
...
//# sourceMappingURL=SPWebPartError.d.ts.map