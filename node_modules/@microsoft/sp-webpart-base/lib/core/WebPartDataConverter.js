...
import { _ServerProcessedDataType as ServerProcessedDataType } from '@microsoft/sp-component-base';
...
var WebPartDataConverter = /** @class */ (function () {
    ...
    WebPartDataConverter.convertServerProcessedDataToHtml = function (serverContent) {
        ...
        if (serverContent) {
            if (serverContent.htmlStrings) {
                result += WebPartDataConverter._convertServerProcessedDataToHtmlByType(serverContent.htmlStrings, ServerProcessedDataType.htmlString);
            }
            if (serverContent.searchablePlainTexts) {
                result += WebPartDataConverter._convertServerProcessedDataToHtmlByType(serverContent.searchablePlainTexts, ServerProcessedDataType.searchablePlainText);
            }
            if (serverContent.links) {
                result += WebPartDataConverter._convertServerProcessedDataToHtmlByType(serverContent.links, ServerProcessedDataType.link);
            }
            if (serverContent.imageSources) {
                result += WebPartDataConverter._convertServerProcessedDataToHtmlByType(serverContent.imageSources, ServerProcessedDataType.imageSource);
            }
        }
        return result;
    };
    ...
    WebPartDataConverter._getHtmlString = function (propName, propType, propValue) {
        ...
        if (propName && typeof propValue === 'string' && propValue) {
            switch (propType) {
                case ServerProcessedDataType.htmlString:
                    ...
                    break;
                case ServerProcessedDataType.searchablePlainText:
                    ...
                    break;
                case ServerProcessedDataType.link:
                    ...
                    break;
                case ServerProcessedDataType.imageSource:
