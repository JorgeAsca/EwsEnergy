import { type ISPEventObserver, type ServiceScope, SPEvent, type SPEventArgs } from '@microsoft/sp-core-library';
import type { IDynamicDataSource } from './interfaces/IDynamicDataSource';
import type { IDynamicDataManager } from './interfaces/IDynamicDataManager';
/**
 ...
 * @internal
 */
export default class DynamicDataManager implements IDynamicDataManager {
    private _sources;
     ...
     * @eventproperty
     */
    get sourcesChangedEvent(): SPEvent<SPEventArgs>;
    /**
...
//# sourceMappingURL=DynamicDataManager.d.ts.map