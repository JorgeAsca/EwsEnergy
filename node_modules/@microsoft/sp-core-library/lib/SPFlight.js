import { initializeEcsClientFeatures, isEcsFlightEnabled } from '@msinternal/ecs-flight';
...
var SPFlight = /** @class */ (function () {
    ...
    SPFlight.initialize = function (flights) {
        ...
        if (SPFlight.isEnabled(REFACTOR_DEBUG_FLIGHTS_AND_KILLSWITCHES_FLIGHT_ID)) {
            ...
            var allowDebug = SPFlight.isDebugFlightEnabled || Environment.type === EnvironmentType.Local;
            if (allowDebug) {
    ...
    /**
     * @public
     * Initialize ECS Client Flights
     * @param ecsFlights - ECS Flights int array
     */
    SPFlight.initializeEcs = function (ecsFlights) {
        initializeEcsClientFeatures(ecsFlights);
        this._isInitializedEcs = true;
    };
    Object.defineProperty(SPFlight, "isDebugFlightEnabled", {
        ...
        get: function () {
            return (SPFlight.isEnabled(SPFX_DEBUG_FLIGHT_ID) ||
                ...
                (SPKillSwitch.isActivated('f5a6830a-99fa-4cc4-8361-62d32a5805f3'
    ...
    /**
     * @public
     * Check if ECS Flight is enabled
     * @param flightName - Name of the ECS Rollout
     */
    SPFlight.isEcsFlightEnabled = function (flightName) {
        if (!this._isInitializedEcs && !DEPRECATED_UNIT_TEST) {
            throw new Error("ECSFlights are not initialized. Flight requested: ".concat(flightName));
        }
        var override = this._overrides.get(flightName);
        if (override !== undefined) {
            return override;
        }
        return isEcsFlightEnabled(flightName);
    };
    ...
    SPFlight._isInitializedEcs = false;
    /**
