...
var ServiceKeys = /** @class */ (function () {
     ...
     */
    ServiceKeys.parentIFrameCommunicatorServiceKey = ServiceKey.createCustom('isolated-webpart-application:ParentIframeCommunicator', function () {
     ...
     */
    ServiceKeys.iDynamicDataManagerServiceKey = ServiceKey.createCustom('sp-dynamic-data:IDynamicDataManager', function () {
