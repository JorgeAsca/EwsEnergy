...
var ServiceKey = /** @class */ (function () {
    ...
    ServiceKey.create = function (name, serviceClass) {
        ...
        return this.createCustom(name, function (serviceScope) {
    ...
    ServiceKey.createCustom = function (name, defaultCreator) {
        ...
        var id = this._generateServiceId(name);
     ...
     */
    ServiceKey._generateServiceId = function (name) {
        var numericId;
        ...
        return Text.replaceAll(name, ' ', '') + '_' + numericId;
    };
    return ServiceKey;
}());
