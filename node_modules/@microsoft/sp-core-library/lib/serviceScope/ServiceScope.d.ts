...
import type { IServiceKey, ServiceClass } from './IServiceKey';
/**
 ...
 * @public
 */
export default class ServiceScope implements IServiceScope {
     ...
     * @internal
     */
    protected _registerService<T>(serviceKey: IServiceKey<T>, service: T): void;
