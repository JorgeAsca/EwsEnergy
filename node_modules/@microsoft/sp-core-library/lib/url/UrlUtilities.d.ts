...
export default class UrlUtilities {
     ...
     */
    static absolutizeUrl(url: string, decode?: boolean): string;
    /**
     * Creates a relative URL from an absolute URL.
     */
    static relativizeUrl(url: string, removeQueryString?: boolean): string;
}
//# sourceMappingURL=UrlUtilities.d.ts.map