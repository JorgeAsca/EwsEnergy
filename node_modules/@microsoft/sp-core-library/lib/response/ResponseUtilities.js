...
var ResponseUtilities = /** @class */ (function () {
    ...
    ResponseUtilities.getRequiredClaims = function (authenticateHeader) {
        ...
        if (claims && claims.length > 0) {
            ...
            if (!SPKillSwitch.isActivated('f9cedb3b-d8bc-4ea1-ae92-3e1725fa2930'
            /* 11/18/2024, 'Decode claims challenges' */
            )) {
                return atob(claims[0][1].replace(/"/g, ''));
            }
            else {
...
export default ResponseUtilities;
