...
var SPEventManager = /** @class */ (function () {
    ...
    SPEventManager.prototype.registerEvent = function (eventName, observer, eventHandler) {
        ...
        eventListeners.push({ observer: observer, eventHandler: eventHandler });
        ...
        var raisedEvents = this._raisedEvents.get(eventName);
        if (raisedEvents) {
            eventHandler.call(observer, raisedEvents);
        }
    };
    /**
    ...
    SPEventManager.prototype.removeEvent = function (eventName) {
        ...
        this._clearStickyEventQueue(eventName);
    };
    /**
    ...
    SPEventManager.prototype._listenerCount = function (eventName) {
        var _a, _b;
        return (_b = (_a = this._listeners.get(eventName)) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0;
    };
    /**
     *
     * @param eventName - Name of the event to clear from the queue.
     */
    SPEventManager.prototype._clearStickyEventQueue = function (eventName) {
        if (this._raisedEvents.has(eventName)) {
            this._raisedEvents.delete(eventName);
        }
    };
    /**
