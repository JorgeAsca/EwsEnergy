...
var Text = /** @class */ (function () {
    ...
    /**
     * Gets a string for the provided locale
     * @param localizedString - object that specifies localized strings
     * @param currentUICultureName - name of the current UI culture
     * @returns string for the provided locale or default string
     *
     * @remarks
     * Format of the localizedStrings parameter:
     * \{
     *   default: 'default locale string',
     *   'en-US': 'US locale string'
     * \}
     *
     * @internal
     */
    Text._getLocalizedString = function (localizedString, currentUICultureName) {
        var culture = currentUICultureName || 'default'; // currentUICultureName can be potentially empty string
        return localizedString[culture] || localizedString.default;
    };
    return Text;
}());
export default Text;
