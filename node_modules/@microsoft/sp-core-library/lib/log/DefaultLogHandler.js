...
var DefaultLogHandler = /** @class */ (function () {
    ...
    DefaultLogHandler.prototype.verbose = function (source, message, scope) {
        if (DEBUG && !DEPRECATED_UNIT_TEST) {
            ...
            console.log(Text.format(strings.logVerboseLevelMessage, source, message));
        }
    };
    DefaultLogHandler.prototype.info = function (source, message, scope) {
        if (DEBUG && !DEPRECATED_UNIT_TEST) {
            // eslint-disable-next-line no-console
            console.info(Text.format(strings.logInfoLevelMessage, source, message));
        }
    };
    DefaultLogHandler.prototype.warn = function (source, message, scope) {
        if (DEBUG && !DEPRECATED_UNIT_TEST) {
            // eslint-disable-next-line no-console
            console.warn(Text.format(strings.logWarningLevelMessage, source, message));
        }
    };
