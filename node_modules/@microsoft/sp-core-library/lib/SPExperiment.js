 ...
 */
import { getVariantAndLogExposure, _getVariantWithoutLogging } from '@msinternal/odsp-core-bundle';
...
var SPExperiment = /** @class */ (function () {
    ...
    SPExperiment.getVariantAndLogExposure = function (experimentId) {
        ...
        var experimentOverride = experimentOverrides === null || experimentOverrides === void 0 ? void 0 : experimentOverrides.get(experimentId);
        if (experimentOverride !== undefined) {
            return experimentOverride;
        }
        return getVariantAndLogExposure(experimentId, SPExperiment._experimentContext);
    };
    /**
    ...
    SPExperiment.setDebugExperiments = function (expOverrides) {
        ...
        var allowDebugQueryParameter = SPFlight.isEnabled(SPFX_DEBUG_EXPERIMENT_ID) || Environment.type === EnvironmentType.Local;
    ...
    SPExperiment._getVariantWithoutLogging = function (experimentId) {
        ...
        return _getVariantWithoutLogging(experimentId, SPExperiment._experimentContext);
    };
