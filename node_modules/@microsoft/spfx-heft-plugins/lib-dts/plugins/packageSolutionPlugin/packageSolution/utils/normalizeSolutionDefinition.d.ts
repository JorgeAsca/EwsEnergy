 ...
 */
export default function normalizeSolutionDefinition(terminal: ITerminal, options: IPackageSolutionConfig, manifests: Map<string, IClientSideComponentManifest>): void;
//# sourceMappingURL=normalizeSolutionDefinition.d.ts.map