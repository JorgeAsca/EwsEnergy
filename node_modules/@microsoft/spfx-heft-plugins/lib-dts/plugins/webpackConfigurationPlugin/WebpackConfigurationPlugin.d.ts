...
import { type IFlightedDependencyConfig, type ISpfxWebpackFolderPaths } from './WebpackConfigurationGenerator';
...
export default class WebpackConfigurationPlugin implements IHeftTaskPlugin {
    private _accessor;
