...
const SERVE_INITIAL_PAGE = REPLACE_WITH_SERVE_INITIAL_PAGE;
const WEBPACK_DEV_SERVER_PORT = REPLACE_WITH_DEV_SERVER_PORT;
...
export function getDevServerConfig(terminal) {
