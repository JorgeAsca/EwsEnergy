 ...
 */ import { getRelativeFilePathsAsync } from './getFiles';
/**
 ...
 */ export async function readResourcesAsync(terminal, options) {
...
/** Reads the list of resources files relative path from a specified folder */ async function getResourceFilePathsAsync(terminal, featureXmlDir, globs) {
    return await getRelativeFilePathsAsync(terminal, featureXmlDir, globs, 'Found resources file: ');
}
