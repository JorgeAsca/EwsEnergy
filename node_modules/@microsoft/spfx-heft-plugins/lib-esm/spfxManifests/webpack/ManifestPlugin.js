...
import { ManifestReferenceResolver } from './ManifestReferenceResolver';
 ...
 */ export class ManifestPlugin {
    apply(compiler) {
        compiler.hooks.thisCompilation.tap(PLUGIN_NAME, (compilation)=>{
            ...
            compilation.hooks.processAssets.tapPromise({
                ...
                await this._options.cumulativeManifestProcessor.generateCumulativeManifestAsync(producedManifests, this._options._manifestsJsFileMetadata, this._options.useManifestsJsonForComponentDependencies ? DependencyDiscoveryMode.shallow : DependencyDiscoveryMode.deepSparseIgnoreFirstProject);
            });
        });
    }
    /**
   ...
   */ _define_property(this, "_options", void 0);
        ...
        this._manifestReferenceResolver = new ManifestReferenceResolver(options.terminal);
    }
}
