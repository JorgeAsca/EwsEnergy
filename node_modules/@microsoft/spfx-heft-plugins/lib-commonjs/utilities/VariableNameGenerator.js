...
Object.defineProperty(exports, "VariableNameGenerator", {
    enumerable: true,
    get: function() {
...
class VariableNameGenerator {
    static async initializeAsync() {
        if (!VariableNameGenerator._javascriptReservedWords) {
            ...
            VariableNameGenerator._javascriptReservedWords = new Set(await _nodecorelibrary.JsonFile.loadAsync(`${__dirname}/javascriptReservedWords.json`));
        }
