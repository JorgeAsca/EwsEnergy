...
Object.defineProperty(exports, "normalizeLocaleName", {
    enumerable: true,
    get: function() {
        return normalizeLocaleName;
    }
});
function normalizeLocaleName(localeName) {
    localeName = localeName.toLowerCase();
    const localeTokens = localeName.split('-');
    if (localeTokens.length === 2) {
        const lastToken = localeTokens[1];
        ...
        const lastToken = localeTokens[2];
        if (lastToken.length === 2) {
    ...
    const normalizedLocale = localeTokens.join('-');
