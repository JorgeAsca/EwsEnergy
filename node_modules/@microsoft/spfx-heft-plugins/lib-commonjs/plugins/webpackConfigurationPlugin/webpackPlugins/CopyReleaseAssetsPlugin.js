    ...
    apply(compiler) {
        compiler.hooks.thisCompilation.tap(PLUGIN_NAME, (compilation)=>{
            ...
            compilation.hooks.processAssets.tapPromise({
                ...
                const relativeAssetsReleasePath = _nodepath.default.relative(// eslint-disable-next-line @typescript-eslint/no-non-null-assertion
                compiler.options.output.path, assetsReleasePath);
                const relativeManifestsReleasePath = _nodepath.default.relative(// eslint-disable-next-line @typescript-eslint/no-non-null-assertion
