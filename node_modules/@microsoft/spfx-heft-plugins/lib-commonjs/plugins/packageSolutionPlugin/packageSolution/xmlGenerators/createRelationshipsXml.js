...
function createRelationshipsXml(xmlSerializationOptions, currentFilename, rels) {
    const file = _nodepath.basename(currentFilename);
    const folder = _nodepath.dirname(currentFilename);
    return {
        filename: _nodepath.posix.join(folder, _constants.default.RelsFolder, file + _constants.default.RelsXml),
