...
/** Reads the list of feature xml filenames from a specified rels folder */ async function getCustomFeatureXmlFilenamesAsync(terminal, featureXmlDir) {
    const filenames = await (0, _getFiles.getRelativeFilePathsAsync)(terminal, _nodepath.join(featureXmlDir, _constants.default.RelsFolder), `*${_constants.default.RelsXml}`, 'Found custom feature file: ');
