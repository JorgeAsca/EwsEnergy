...
Object.defineProperty(exports, "ManifestUrlProcessor", {
    enumerable: true,
    get: function() {
        return ManifestUrlProcessor;
    }
});
const _UrlUtilities = require("../../utilities/UrlUtilities");
class ManifestUrlProcessor {
    /**
   ...
   */ static processInternalModuleBaseUrls(manifest, relativePath, baseUrl) {
        ...
        const url = _UrlUtilities.UrlUtilities.joinUrlSegments(baseUrl, relativePath);
        ...
        manifest.loaderConfig.internalModuleBaseUrls = manifestBaseUrls.map((manifestBaseUrl)=>{
            return _UrlUtilities.UrlUtilities.ensureTrailingSlash(manifestBaseUrl);
        });
    }
}
