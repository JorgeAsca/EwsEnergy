...
Object.defineProperty(exports, "TerminalHelper", {
    enumerable: true,
    get: function() {
...
class TerminalHelper {
   ...
   */ static getTerminalForWebpackPlugin(compilation) {
        ...
        return new _terminal.Terminal({
            eolCharacter: '\n',
            supportsColor: false,
            write: (message, severity)=>{
                switch(severity){
                    case _terminal.TerminalProviderSeverity.error:
                        {
                            compilation.errors.push(new WebpackError(message.trim()));
                            break;
                        }
                    case _terminal.TerminalProviderSeverity.warning:
                        {
