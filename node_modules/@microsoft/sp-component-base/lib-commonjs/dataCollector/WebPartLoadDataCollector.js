...
var WebPartLoadDataCollector = /** @class */ (function () {
    ...
    WebPartLoadDataCollector.collect = function (manifest, webPartTag, pageContext) {
        ...
        var cacheMissReason = IWebPartLoadData_1._CacheMissReason.NotApplicable;
    ...
    WebPartLoadDataCollector._getCacheMissReason = function (cacheHit, getTime) {
        if (cacheHit) {
            return IWebPartLoadData_1._CacheMissReason.NotApplicable;
        }
        ...
        var cacheMissReason = IWebPartLoadData_1._CacheMissReason.NotSpecified;
        if (mySiteCacheMissOnConfgMismatch) {
            cacheMissReason = IWebPartLoadData_1._CacheMissReason.CacheConfigMissmatch;
        }
        else if (mySiteCacheMissOnLateFlush) {
            cacheMissReason = IWebPartLoadData_1._CacheMissReason.LateFlush;
        }
        else if (cachedWebPartNotFound) {
            cacheMissReason = IWebPartLoadData_1._CacheMissReason.CachedItemNotFound;
        }
        else if (cacheExpired) {
            cacheMissReason = IWebPartLoadData_1._CacheMissReason.CacheExpired;
        }
