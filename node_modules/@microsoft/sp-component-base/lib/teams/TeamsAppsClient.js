...
import { isBotAcesFromTeamsEnabled } from '../common/Flights';
...
var TeamsAppsClient = /** @class */ (function () {
    ...
    TeamsAppsClient.prototype.getTeamsAppComponentManifests = function () {
        ...
        if (!TeamsAppsClient._getTeamsAppComponentManifestsPromise) {
            if (!isBotAcesFromTeamsEnabled()) {
                ...
                var monitor_1 = new _QosMonitor('TeamsAppsClient.FetchTeamsApp');
    ...
    TeamsAppsClient.prototype.syncComponent = function (teamsAppComponentManifest) {
        ...
        if (!isBotAcesFromTeamsEnabled() || !manifest.isPendingTeamsAppSync) {
            return Promise.resolve(teamsAppComponentManifest);
        }
        var monitor = new _QosMonitor('TeamsAppsClient.SyncComponent');
        ...
        var spHttpClient = this._serviceScope.consume(SPHttpClient.serviceKey);
        var pageContext = this._serviceScope.consume(PageContext.serviceKey);
        ...
        if (!TeamsAppsClient._ensureAppCatalogPromise) {
            ...
            ensureAppCatalogPromise = TeamsAppsClient._ensureAppCatalogPromise = spHttpClient
                .post(ensureAppCatalogRequestUrl, SPHttpClient.configurations.v1, {})
                .then(function (response) {
        ...
        return ensureAppCatalogPromise
            ...
            return spHttpClient
                .post(syncRequestUrl, SPHttpClient.configurations.v1, {
                body: JSON.stringify({
    ...
    TeamsAppsClient.prototype.requestPermissions = function (teamsAppComponentIds) {
        if (!isBotAcesFromTeamsEnabled() || !teamsAppComponentIds.length) {
    ...
    TeamsAppsClient.prototype._requestAppsPermissions = function (teamsAppComponentIds) {
        ...
        var uniqueAppIds = uniq(teamsAppComponentIds.map(function (item) { return item.appId; })).filter(function (appId) { return !_this._appComponentsPermissionsPromises.has(appId); });
        ...
        if (!requestPermissionsPromise) {
            var monitor_2 = new _QosMonitor('TeamsAppsClient.RequestAppsPermissions');
    ...
    TeamsAppsClient.prototype._requestAppsPermissionsBatched = function (appIds) {
        var monitor = new _QosMonitor('TeamsAppsClient.RequestAppsPermissionsBatched');
        var allowedApps = new Set();
        //
    ...
    Object.defineProperty(TeamsAppsClient.prototype, "_msGraphClient", {
        get: function () {
            if (!this._msGraphClientFactory) {
                this._msGraphClientFactory = this._serviceScope.consume(MSGraphClientFactory.serviceKey);
            }
