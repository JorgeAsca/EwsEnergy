import { type IDisposable, type ServiceScope } from '@microsoft/sp-core-library';
import { type IDynamicDataCallables, type IDynamicDataSource, type IDynamicDataSourceMetadata } from '@microsoft/sp-dynamic-data';
...
export default class DynamicDataSourceManager implements IDisposable {
     ...
     * @internal
     */
    get _source(): IDynamicDataSource | undefined;
    /**
