...
import { _EngagementLogger, _LogEntry, _LogType, _TraceLogger, _LogSource, _QosMonitor } from '@microsoft/sp-diagnostics';
...
import { isExemptWebPartWithDynamicDataFromLazyLoadKSActivated } from './common/KillSwitches';
/**
...
var DynamicDataSourceManager = /** @class */ (function () {
    ...
    DynamicDataSourceManager.prototype.updateMetadata = function (metadata) {
        ...
        merge(this._src.metadata, metadata);
    };
    ...
    DynamicDataSourceManager.prototype._allowedEvents = function () {
        return this._callableFunctions.allowedEvents
            ? cloneDeep(this._callableFunctions.allowedEvents())
            : undefined;
    };
    /**
    ...
    DynamicDataSourceManager.prototype._getPropertyValue = function (propertyId) {
        ...
        var qosMonitor = new _QosMonitor('DynamicDataSourceManager._getPropertyValue');
        ...
        try {
            ...
            qosMonitor.writeSuccess(__assign(__assign({}, ((this._src && this._src.metadata) || {})), { sourceId: this._src && this._src.id, propertyId: propertyId }));
    ...
    DynamicDataSourceManager.prototype._getAnnotatedPropertyValue = function (propertyId) {
        Validate.isNotNullOrUndefined(propertyId, 'propertyId');
        var qosMonitor = new _QosMonitor('DynamicDataSourceManager._getAnnotatedPropertyValue');
        ...
        if (getAnnotatedPropertyValue) {
            ...
            try {
                ...
                qosMonitor.writeSuccess(__assign(__assign({}, ((this._src && this._src.metadata) || {})), { sourceId: this._src && this._src.id, annotatedPropertyValue: annotatedPropertyValue, propertyId: propertyId }));
            }
            catch (error) {
    ...
    DynamicDataSourceManager.prototype._assertValidEvent = function (eventName) {
        if (!this._allowedEvents() || findIndex(this._allowedEvents(), { name: eventName }) === -1) {
            throw new Error(Text.format(strings.InvalidEvent, eventName, this._src.metadata.title));
        }
    };
