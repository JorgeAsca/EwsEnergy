...
var ThemeProvider = /** @class */ (function () {
     ...
     */
    function ThemeProvider(serviceScope, theme, themeV2) {
        ...
        if (themeV2) {
            this._themeV2 = Object.freeze(themeV2);
        }
    }
     ...
     * @internal
     */
    ThemeProvider.prototype._setTheme = function (theme, themeV2) {
    ...
    ThemeProvider.prototype.tryGetThemeV2 = function () {
        return this._themeV2;
    };
    ThemeProvider.prototype._raiseEvent = function () {
        _SPEventManager.instance.raiseEvent(this._themeChangedEventName, {
            theme: this._theme,
            themeV2: this._themeV2
        });
    };
    /**
