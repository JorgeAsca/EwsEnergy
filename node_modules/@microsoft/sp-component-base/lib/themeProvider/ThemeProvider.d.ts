import { ServiceKey, type ServiceScope, SPEvent, SPEventArgs } from '@microsoft/sp-core-library';
import type { ITheme, IReadonlyTheme } from './themeInterfaces/ITheme';
...
export declare class ThemeProvider {
     ...
     * @internal
     */
    _setTheme(theme: ITheme, themeV2?: Theme): void;
    /**
