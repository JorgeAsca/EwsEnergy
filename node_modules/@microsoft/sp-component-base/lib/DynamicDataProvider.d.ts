import { type IDisposable, type ServiceScope, Guid } from '@microsoft/sp-core-library';
import { type DynamicDataReference, type IDynamicDataSource } from '@microsoft/sp-dynamic-data';
...
export default class DynamicDataProvider implements IDisposable {
     ...
     * @internal
     */
    get _isProviderInitialized(): boolean;
    /**
