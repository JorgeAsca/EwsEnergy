import type { ServiceScope, ISPEventObserver } from '@microsoft/sp-core-library';
import type { IClientSideComponentManifest } from '@microsoft/sp-module-interfaces';
import type BaseComponentContext from './BaseComponentContext';
/**
...
export default abstract class BaseComponent implements ISPEventObserver {
     ...
     * @internal
     */
    protected _isWebPartAndContainsDynamicDataSource: boolean;
    private _isDisposed;
    /**
     ...
     * @internal
     */
    get _containsDynamicDataSource(): boolean;
    set _containsDynamicDataSource(val: boolean);
    /**
