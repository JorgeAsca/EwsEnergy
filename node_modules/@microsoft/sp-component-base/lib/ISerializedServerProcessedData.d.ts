 ...
 * @internal
 */
export declare const ServerProcessedDataType: {
    /**
     * The date type is valid html string.
     */
    readonly htmlString: 1;
    /**
     ...
     * The link can be a SharePoint content link or non-SharePoint link.
     */
    readonly imageSource: 3;
    /**
     * The data type is a string that should be search indexed.
     */
    readonly searchablePlainText: 4;
};
/**
 * {@inheritdoc (_ServerProcessedDataType:variable)}
 * @internal
 */
export type ServerProcessedDataType = (typeof ServerProcessedDataType)[keyof typeof ServerProcessedDataType];
/**
