...
import { SafeHtml } from '@msinternal/sp-safehtml';
/**
...
var PropertyMetadataProcessor = /** @class */ (function () {
    ...
    PropertyMetadataProcessor.reInstateServerProcessedData = function (propertiesMetadata, properties, serverProcessedContent, manifest) {
        ...
        if (manifest) {
            ...
            this._forEachPropertyWithMetaData(propertiesMetadata, properties, function (propPath, metadata) {
                if (!isServerPropertiesSanitizedEnabled()) {
                    ...
                    if (manifest.id === 'b7dd04e1-19ce-4b24-9132-b60a1c2b910d' &&
                        _SPKillSwitch.isActivated('71b68bd4-eb7a-4330-93bd-dc6d382123c1' /* '9/28/2023', 'Do not serverProcessContent sanitization for DocumentEmbedWebPart' */)) {
                        return;
                    }
                    // eslint-disable-next-line @typescript-eslint/no-explicit-any
                    var propValue = lodash.get(properties, propPath);
                    if (propValue !== undefined) {
                        var qosMonitor = new _QosMonitor('PropertyMetadataProcessor.clearMetadataValue');
                        if (metadata.isLink) {
        ...
        if (isServerPropertiesSanitizedEnabled() &&
            ...
            var logServerPropertiesMissing = new _QosMonitor('PropertyMetadataProcessor.serverProcessedContentMissing');
    ...
    PropertyMetadataProcessor._isSafeLink = function (link) {
        try {
            ...
            return SafeHtml.isSafeLinkProtocol(safeLinkUrl.protocol);
        }
        catch (_a) {
            try {
...
export { PropertyMetadataProcessor };
function isFixCustomMetadataKeyKillSwitchActivated() {
    return _SPKillSwitch.isActivated('bf085c27-422d-4b62-a93a-43efa89e77ee'
