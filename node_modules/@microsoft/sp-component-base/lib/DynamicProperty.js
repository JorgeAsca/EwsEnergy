...
import { _SPKillSwitch, Validate } from '@microsoft/sp-core-library';
import { DynamicDataReference } from '@microsoft/sp-dynamic-data';
import DynamicDataProvider from './DynamicDataProvider';
import { _LogEntry, _EngagementLogger, _LogType } from '@microsoft/sp-diagnostics';
/**
...
var DynamicProperty = /** @class */ (function () {
    ...
    DynamicProperty.prototype.tryGetValue = function () {
        if (this.isDisposed &&
            !_SPKillSwitch.isActivated('413769dc-5e0c-4609-9c86-bdf099fe84e3' /*, '12/02/2021', 'DisposedUndefinedNotException'*/)) {
            return undefined;
        }
        else {
    ...
    DynamicProperty.prototype._getData = function () {
        ...
        try {
            ...
            _EngagementLogger.logEventWithLogEntry(error);
            throw error;
        }
        _EngagementLogger.logEventWithLogEntry(new _LogEntry('DynamicData', 'getData', _LogType.Event, { value: JSON.stringify(this.value) }));
        return value;
    };
    /**
