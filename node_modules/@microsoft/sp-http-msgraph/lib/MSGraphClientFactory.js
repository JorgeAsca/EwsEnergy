import { ServiceKey, _SPKillSwitch } from '@microsoft/sp-core-library';
...
var MSGraphClientFactory = /** @class */ (function () {
    ...
    MSGraphClientFactory.prototype.getClient = function (version, options) {
        ...
        if (!version || version === '1') {
            ...
            !_SPKillSwitch.isActivated('24401914-15d6-4c3c-aeea-4aace46d5586' /* '01/06/2022', 'use new MSGraphVersion' */)) {
            var qosMonitor_1 = new _QosMonitor('MSGraphClientFactory.GetClientV3');
            // returns a v3 version of MSGraphClient
            // Should only import once no matter how many times it is called
            return import(/* webpackChunkName: 'sp-http-msgraphclientv3' */ './MSGraphClientV3')
                .then(function (msGraphClientV3) {
    ...
    MSGraphClientFactory.prototype.getClientWithMiddleware = function (version, options) {
        var _this = this;
        var qosMonitor = new _QosMonitor('MSGraphClientFactory.GetClientV3WithMiddleware');
        // returns a v3 version of MSGraphClient
        // Should only import once no matter how many times it is called
        return import(/* webpackChunkName: 'sp-http-msgraphclientv3' */ './MSGraphClientV3')
            .then(function (msGraphClientV3) {
    ...
    MSGraphClientFactory.prototype.getClientInternal = function (version, options) {
        var _this = this;
        var qosMonitor = new _QosMonitor('MSGraphClientFactory.GetInternalClientV3');
        // Should only import once no matter how many times it is called
        return import(/* webpackChunkName: 'sp-http-msgraphclientv3' */ './MSGraphClientV3')
            .then(function (msGraphClientV3) {
            // We create a new object every time rather than referencing an existing object in case the service scope changes
