...
import strings from './SPHttpMsGraphStrings.resx';
/**
...
var MSGraphClient = /** @class */ (function () {
    ...
    function MSGraphClient(serviceScope) {
        ...
        serviceScope.whenFinished(function () {
            ...
            if (!MSGraphClient._instance) {
                MSGraphClient._instance = _this._createGraphClientInstance(_AadTokenProviders.configurable);
            }
        });
    }
    /**
    ...
    MSGraphClient.prototype.api = function (path, config) {
        ...
        MSGraphClient._instance.config = __assign(__assign({}, MSGraphClient._originalConfig), (config || {}));
