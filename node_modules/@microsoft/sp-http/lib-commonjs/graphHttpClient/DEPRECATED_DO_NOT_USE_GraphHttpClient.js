...
var DEPRECATED_DO_NOT_USE_GraphHttpClientResponse_1 = tslib_1.__importDefault(require("./DEPRECATED_DO_NOT_USE_GraphHttpClientResponse"));
var DEPRECATED_DO_NOT_USE_GraphHttpClientConfiguration_1 = require("./DEPRECATED_DO_NOT_USE_GraphHttpClientConfiguration");
/**
...
var DEPRECATED_DO_NOT_USE_GraphHttpClient = /** @class */ (function () {
    function DEPRECATED_DO_NOT_USE_GraphHttpClient(serviceScope) {
        var _this = this;
        this._serviceScope = serviceScope;
        this._serviceScope.whenFinished(function () {
            _this._tokenProvider = serviceScope.consume(sp_http_base_1._DEPRECATED_DO_NOT_USE_OAuthTokenProvider.serviceKey);
    ...
    DEPRECATED_DO_NOT_USE_GraphHttpClient.prototype.fetch = function (url, configuration, options, cacheConfiguration) {
        var _this = this;
    ...
    DEPRECATED_DO_NOT_USE_GraphHttpClient.prototype.get = function (url, configuration, options, cacheConfiguration) {
     ...
     */
    DEPRECATED_DO_NOT_USE_GraphHttpClient.prototype.post = function (url, configuration, options) {
        return this._fetch(url, configuration, sp_http_base_1._HttpClientHelper.overrideHttpMethod(options, 'POST'));
    };
    DEPRECATED_DO_NOT_USE_GraphHttpClient.prototype._fetch = function (url, configuration, options) {
        var _this = this;
        ...
        return this._getOAuthToken().then(function () {
            ...
            return _this._fetchWithInstrumentation(configuration, new Request(_this._graphContext.getGraphEndpointUrl() + '/' + url, modifiedOptions)).then(function (response) {
                return new DEPRECATED_DO_NOT_USE_GraphHttpClientResponse_1.default(response);
            });
        });
    };
    DEPRECATED_DO_NOT_USE_GraphHttpClient.prototype._fetchWithInstrumentation = function (configuration, request) {
        return sp_http_base_1._HttpClientHelper
            .fetchCore(configuration, request, this._serviceScope, this._fetchProvider, DEPRECATED_DO_NOT_USE_GraphHttpClient._className)
    ...
    DEPRECATED_DO_NOT_USE_GraphHttpClient.prototype._getOAuthToken = function () {
        var _this = this;
    ...
    Object.defineProperty(DEPRECATED_DO_NOT_USE_GraphHttpClient.prototype, "_cacheDataProvider", {
        /**
    ...
    Object.defineProperty(DEPRECATED_DO_NOT_USE_GraphHttpClient.prototype, "_logSourceId", {
        get: function () {
            if (this._parentSource.isEmpty()) {
                return DEPRECATED_DO_NOT_USE_GraphHttpClient._logSource.id;
            }
    ...
    DEPRECATED_DO_NOT_USE_GraphHttpClient.prototype._mergeUserHeaders = function (defaultHeaders, userHeaders) {
        userHeaders.forEach(function (value, name) {
            defaultHeaders.set(name, value); // note name/value are reversed
        });
        return defaultHeaders;
    };
    DEPRECATED_DO_NOT_USE_GraphHttpClient.prototype._writeQosMonitorUpdate = function (response, qosMonitor, operation) {
     ...
     */
    DEPRECATED_DO_NOT_USE_GraphHttpClient.prototype._validateGraphRelativeUrl = function (url) {
     ...
     */
    DEPRECATED_DO_NOT_USE_GraphHttpClient.configurations = DEPRECATED_DO_NOT_USE_GraphHttpClientConfiguration_1.predefinedConfigurations;
    /**
     * The service key for GraphHttpClient.
     */
    DEPRECATED_DO_NOT_USE_GraphHttpClient.serviceKey = sp_core_library_1.ServiceKey.create('sp-http:GraphHttpClient', DEPRECATED_DO_NOT_USE_GraphHttpClient);
    DEPRECATED_DO_NOT_USE_GraphHttpClient._className = 'DEPRECATED_DO_NOT_USE_GraphHttpClient';
    DEPRECATED_DO_NOT_USE_GraphHttpClient._logSource = sp_diagnostics_1._LogSource.create('DEPRECATED_DO_NOT_USE_GraphHttpClient');
    return DEPRECATED_DO_NOT_USE_GraphHttpClient;
}());
exports.default = DEPRECATED_DO_NOT_USE_GraphHttpClient;
//# sourceMappingURL=DEPRECATED_DO_NOT_USE_GraphHttpClient.js.map