...
exports.PathResolutionMethod = PathResolutionMethod;
...
class ConfigurationFileBase {
    ...
    getObjectSourceFilePath(obj) {
        const { [exports.CONFIGURATION_FILE_FIELD_ANNOTATION]: annotation } = obj;
    ...
    getPropertyOriginalValue(options) {
        ...
        const { [exports.CONFIGURATION_FILE_FIELD_ANNOTATION]: annotation } = parentObject;
    ...
    _contextualizeConfigurationFile(entry, projectFolderPath) {
        ...
        const result = (0, structured_clone_1.default)(entry.configurationFile);
            ...
            if (node_core_library_1.FileSystem.isNotExistError(e)) {
                ...
                if (fallbackPath) {
                    try {
                        ...
                        if (!node_core_library_1.FileSystem.isNotExistError(fallbackError)) {
                            throw fallbackError;
                        }
    ...
    async _loadConfigurationFileEntryAsync(terminal, resolvedConfigurationFilePath, visitedConfigurationFilePaths, fileNotFoundFallback) {
        ...
        if (configurationJson.extends) {
            try {
                const resolvedParentConfigPath = await node_core_library_1.Import.resolveModuleAsync({
                    modulePath: configurationJson.extends,
                    baseFolderPath: nodeJsPath.dirname(resolvedConfigurationFilePath)
                });
    ...
    _mergeConfigurationFiles(parentConfiguration, configurationJson, resolvedConfigurationFilePath) {
        ...
        result[exports.CONFIGURATION_FILE_FIELD_ANNOTATION].schemaPropertyOriginalValue = schemaPropertyOriginalValue;
        return result;
    }
                    ...
                    case InheritanceType.append: {
                        ...
                        newValue[exports.CONFIGURATION_FILE_FIELD_ANNOTATION] = {
                            ...
                            originalValues: {
                                ...
                                ...parentPropertyValue[exports.CONFIGURATION_FILE_FIELD_ANNOTATION].originalValues,
                                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                                ...propertyValue[exports.CONFIGURATION_FILE_FIELD_ANNOTATION].originalValues
                            }
                        };
                        break;
                    }
