...
exports.HeftLifecycleSession = void 0;
const path = __importStar(require("node:path"));
class HeftLifecycleSession {
    constructor(options) {
        ...
        const uniquePluginFolderName = `lifecycle.${options.pluginDefinition.pluginName}`;
    ...
    requestAccessToPluginByName(pluginToAccessPackage, pluginToAccessName, pluginApply) {
        ...
        const pluginHookName = this._pluginHost.getPluginHookName(pluginPackageName, pluginName);
        this._pluginHost.requestAccessToPluginByName(pluginHookName, pluginToAccessPackage, pluginToAccessName, pluginApply);
    }
}
exports.HeftLifecycleSession = HeftLifecycleSession;
//# sourceMappingURL=HeftLifecycleSession.js.map