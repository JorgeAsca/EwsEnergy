...
class HeftLifecycle extends HeftPluginHost_1.HeftPluginHost {
    ...
    constructor(internalHeftSession, lifecyclePluginSpecifiers) {
        ...
        this._lifecycleHooks = {
            ...
            taskStart: new tapable_1.SyncHook(['task']),
            taskFinish: new tapable_1.SyncHook(['task']),
            phaseStart: new tapable_1.SyncHook(['phase']),
            phaseFinish: new tapable_1.SyncHook(['phase'])
        };
    }
