...
type TrimmedLinter = Omit<TTslint.Linter, 'getAllFailures' | 'applyAllFixes' | 'getEnabledRules' | 'failures'>;
export interface IExtendedLinter extends TrimmedLinter {
     ...
     */
    applyAllFixes(enabledRules: TTslint.IRule[], fileFailures: TTslint.RuleFailure[], sourceFile: TTypescript.SourceFile, sourceFileName: string): TTslint.RuleFailure[];
}
export {};
