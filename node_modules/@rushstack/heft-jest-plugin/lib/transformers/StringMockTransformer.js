...
exports.StringMockTransformer = void 0;
 ...
 * environment.
 */
class StringMockTransformer {
    process(sourceText, sourcePath, options) {
        // heft-jest-plugin enforces that config.rootDir will always be the project root folder.
        const relativePath = (0, node_path_1.relative)(options.config.rootDir, sourcePath);
        const normalizedRelativePath = isWindows ? relativePath.replace(/\\/g, '/') : relativePath;
...
exports.StringMockTransformer = StringMockTransformer;
//# sourceMappingURL=StringMockTransformer.js.map