...
var PersonalService_1 = require("./PersonalService");
    ...
    AsignacionesService.prototype.getDatosPanel = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        projectService = new ProjectService_1.ProjectService(this._context);
                        personalService = new PersonalService_1.PersonalService(this._context);
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        endpoint = "".concat(this._context.pageContext.web.absoluteUrl, "/_api/web/lists/getbytitle('").concat(this._listName, "')/items");
                        return [4 /*yield*/, this._context.spHttpClient.post(endpoint, sp_http_1.SPHttpClient.configurations.v1, options)];
                    case 1:
                        response = _a.sent();
                        if (!response.ok)
