            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this._context.spHttpClient.post(endpointFile, sp_http_1.SPHttpClient.configurations.v1, uploadOptions)];
                    case 3:
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._context.spHttpClient.get(checkEndpoint, sp_http_1.SPHttpClient.configurations.v1)];
                    case 1:
                        checkResponse = _a.sent();
                        if (!(checkResponse.status === 404)) return [3 /*break*/, 3];
                        createEndpoint = "".concat(siteUrl, "/_api/web/folders");
                        return [4 /*yield*/, this._context.spHttpClient.post(createEndpoint, sp_http_1.SPHttpClient.configurations.v1, {
