                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, obras.map(function (obra) {
                                ...
                                return tslib_1.__assign(tslib_1.__assign({}, obra), { clienteNombre: ((_a = obra.Cliente) === null || _a === void 0 ? void 0 : _a.Title) || "Sin Cliente", porcentajeReal: obra.ProgresoReal || 0, operarios: operariosProps, jornadasConsumidas: Math.round(((obra.ProgresoReal || 0) / 100) * (obra.JornadasTotales || 30)) });
                            })];
                }
            });
        });
